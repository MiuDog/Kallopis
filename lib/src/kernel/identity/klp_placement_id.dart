...
final class KlpPlacementId {
	...
	KlpPlacementId({List<String> scope = const [], required this.localId}) : scope = List.unmodifiable(scope);

	@override
	bool operator ==(Object other) {
		if (identical(this, other)) return true;
		if (other is! KlpPlacementId || localId != other.localId || scope.length != other.scope.length) return false;
