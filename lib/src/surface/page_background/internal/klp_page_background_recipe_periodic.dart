...
final class KlpRuledPageBackgroundRecipe extends KlpPageBackgroundRecipe {
	KlpRuledPageBackgroundRecipe({
		...
		if (resolvedSpacing != null) _requirePositiveFinite(resolvedSpacing, 'spacing');
	}
...
sealed class KlpPeriodicPageBackgroundRecipe extends KlpPageBackgroundRecipe {
	KlpPeriodicPageBackgroundRecipe({
		...
		if (resolvedSpacing != null) _requirePositiveFinite(resolvedSpacing, 'majorSpacing');
		if (minorAxisCount < 0) throw ArgumentError.value(minorAxisCount, 'minorAxisCount', 'must not be negative');
	}
	...
	int get periodicHashCode => Object.hash(minorAxis, majorAxis, majorSpacing, minorAxisCount, strokeBehavior);
}

/// 以點徑呈現主次週期的背景。
final class KlpDotsPageBackgroundRecipe extends KlpPeriodicPageBackgroundRecipe {
	...
	@override
	bool operator ==(Object other) => other is KlpDotsPageBackgroundRecipe && equalsPeriodic(other);
	@override
	int get hashCode => Object.hash(runtimeType, periodicHashCode);
}

/// 以水平與垂直線呈現主次週期的背景。
final class KlpGridPageBackgroundRecipe extends KlpPeriodicPageBackgroundRecipe {
	...
	@override
	bool operator ==(Object other) => other is KlpGridPageBackgroundRecipe && equalsPeriodic(other);
	@override
	int get hashCode => Object.hash(runtimeType, periodicHashCode);
}
