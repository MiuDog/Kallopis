	...
	Widget build(BuildContext context) => Semantics(
		...
		child: GestureDetector(
			...
			child: KlpSurface(
				...
				padding: EdgeInsets.all(context.klp.space.contentInset),
				child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [Row(children: [Expanded(child: KlpText(title, role: KlpTextRole.bodyStrong)), KlpBadge(label: typeLabel)]), SizedBox(height: context.klp.space.contentStackGap), child]),
			),
		),
	);
}
...
class KlpFlowValidationPanel extends StatelessWidget {
	...
	Widget build(BuildContext context) => Column(
		...
		children: [
			...
			if (recoveryActions.isNotEmpty) ...[SizedBox(height: context.klp.space.contentStackGap), Wrap(spacing: context.klp.space.tight, children: recoveryActions)],
		],
	);
}
