  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      physics: const ClampingScrollPhysics(),
			padding: EdgeInsets.symmetric(horizontal: context.klp.space.chromePanelInset),
      children: [
        for (final section in effectiveSections)
          KlpFileExplorerSection._render(
            ...
            child: KlpFileExplorerSectionView(
              ...
              sectionMargin: widget.sectionMargin,
...
class KlpFileExplorerSectionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: sectionMargin ?? EdgeInsets.zero,
          child: SizedBox(
            ...
            child: KlpPressable(
              ...
              child: Padding(
                padding:
                    sectionPadding ??
										EdgeInsets.symmetric(horizontal: klp.space.navigationItemInset),
                child: Row(
                  children: [
