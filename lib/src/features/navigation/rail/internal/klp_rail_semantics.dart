...
final class KlpRailSemantics {
	...
	static final itemBackground = KlpSemanticKey(
		KlpRail.typeId,
		'itemBackground',
		KlpStyleKind.color,
	);
	static final selectedBackground = KlpSemanticKey(
		KlpRail.typeId,
		'selectedBackground',
		KlpStyleKind.color,
	);
	static final focusColor = KlpSemanticKey(
		KlpRail.typeId,
		'focusColor',
		KlpStyleKind.color,
	);
	static final width = KlpSemanticKey(
		KlpRail.typeId,
		'width',
		KlpStyleKind.distance,
	);
	static final itemExtent = KlpSemanticKey(
		KlpRail.typeId,
		'itemExtent',
		KlpStyleKind.distance,
	);
	...
	static final gap = KlpSemanticKey(
		KlpRail.typeId,
		'gap',
		KlpStyleKind.distance,
	);
	...
	static final focusWidth = KlpSemanticKey(
		KlpRail.typeId,
		'focusWidth',
		KlpStyleKind.strokeWidth,
	);

	static KlpSemanticToken<T> _token<T extends KlpStyleValue>(
		KlpSemanticKey<T> key,
		KlpPrimitiveIndex index,
	) => KlpSemanticToken(key, KlpPrimitiveRef(key.kind, index));
	...
	static KlpSemanticSchema createSchema() => KlpSemanticSchema(KlpRail.typeId, [
		...
		_token(selectedBackground, KlpPrimitiveIndex.i5),
