...
final class _Prepared implements KlpPreparedNode {
	...
	KlpBoundTemplate materialize(KlpPlacementResource resource, List<KlpBoundTemplate> children, KlpFrameLease lease) {
		...
		return KlpBoundWorkspaceBlock(
			kind: block.kind.index, title: block.title, toolbarAlignment: block.toolbarAlignment.index, symbol: block.symbol, icon: block.icon?.index, subtitle: block.subtitle, lines: block.lines, checklist: block.checklist, checklistTitle: block.checklistTitle,
