...
class _KlpRadioItem extends StatelessWidget {
	const _KlpRadioItem({required this.label, this.description, required this.selected, required this.onPressed});
	...
	Widget build(BuildContext context) {
		...
		return _KlpRadioItemFrame(
			...
			child: KlpRow(
				...
				children: [
					_KlpRadioIndicatorFrame(label: label, selected: selected, style: style),
						...
						child: KlpColumn(
							...
							children: [
								...
								if (description != null) ...[
									...
									KlpText(description!, role: KlpTextRole.caption, tone: KlpTextTone.muted),
								],
							],
						),
					),
