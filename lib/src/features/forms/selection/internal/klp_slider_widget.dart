			...
			children: [
				KlpRow(
					children: [
						...
						KlpText(displayValue ?? '${(value * 100).round()}%', role: KlpTextRole.code, tone: KlpTextTone.muted),
					],
				),
				_KlpSliderFrame(
				...
				if (marks != null && marks!.isNotEmpty)
					KlpRow(
						...
						children: [for (final mark in marks!) KlpText(mark, role: KlpTextRole.caption, tone: KlpTextTone.faint)],
					),
			],
		);
	}
