	...
	Widget build(BuildContext context) {
		...
		final field = KlpStrokeFrame(
			...
			child: _KlpSelectActionFrame(
				...
				child: KlpRow(
					children: [
						KlpExpanded(child: KlpText(widget.value, tone: widget.enabled ? KlpTextTone.primary : KlpTextTone.faint)),
						KlpIcon(KlpIcons.chevronDown, size: context.klp.space.iconSmall, color: style.iconColor),
					],
				),
			),
		);
