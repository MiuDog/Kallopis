...
class KlpRegionPlaceholder extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		...
		final effectiveConstraints = constraints ?? KlpBoxConstraints(minHeight: geometry.placeholderMinimumHeight);
								...
								children: [
									KlpExcludeSemantics(
										child: KlpRow(
											mainAxisSize: MainAxisSize.min,
											children: [
												_KlpPlaceholderMarkerGlyph(pending: tone == KlpRegionPlaceholderTone.pending),
									...
									if (detail != null) ...[
										...
										KlpExcludeSemantics(
											child: KlpConstrainedBox(
												constraints: KlpBoxConstraints(maxWidth: geometry.placeholderDetailMaximumWidth),
												child: KlpText(
													detail!,
									...
									if (actionLabel != null) ...[
										...
										_PlaceholderAction(label: actionLabel!, onPressed: onAction),
									],
								],
							),
						),
