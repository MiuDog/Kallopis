...
final class KlpScopeBoundary implements KlpCompositeNode {
	...
	static final childSlot = KlpSlot<KlpNode>(owner: typeId, name: 'child', min: 1, max: 1);
	static final contract = KlpDefinition<KlpScopeBoundary>(typeId, slots: [childSlot]);
	...
	KlpScopeBoundary({required this.id, required KlpNode child, this.active = true}) : children = KlpChildren([childSlot.assign([child])]);
