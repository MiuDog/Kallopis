...
final class KlpChildren extends IterableBase<KlpNode> {
	...
	KlpChildren(List<KlpSlotAssignment<KlpNode>> assignments) : assignments = List.unmodifiable(assignments) {
		_children = List.unmodifiable(this.assignments.expand((assignment) => assignment.children));
	}
