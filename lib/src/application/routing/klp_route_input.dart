...
final class KlpRouteInput<P, R> {
	...
	KlpAction navigate<T>(KlpLocation<T> location, {void Function(T value)? onResult}) => _KlpPushAction<T>(_actions, location, onResult);
...
final class _KlpPushAction<T> implements _KlpRouteAction {
	...
	@override
	Future<KlpActionActivation> activate(_KlpApplicationActionHandler handler) => handler.push(this);
}
...
final class _KlpFinishAction implements _KlpRouteAction {
	...
	@override
	Future<KlpActionActivation> activate(_KlpApplicationActionHandler handler) => handler.finish(this);
}
...
final class _KlpBackAction implements _KlpRouteAction {
	...
	@override
	Future<KlpActionActivation> activate(_KlpApplicationActionHandler handler) => handler.back(this);
}
