...
final class KlpApplicationEnvironment {
	...
	final KlpApplicationAppearance appearance;
...
/// 應用宿主從系統取得的明暗外觀，不接受 consumer 覆寫。
enum KlpApplicationAppearance { light, dark }

/// 系統輔助功能偏好。基本語意與鍵盤支援不受此值關閉。
final class KlpAccessibilityPreferences {

	const KlpAccessibilityPreferences._({required this.accessibleNavigation, required this.boldText, required this.highContrast});
