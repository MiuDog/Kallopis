...
import 'internal/klp_flutter_menu_panel.dart';
...
import 'internal/klp_flutter_explorer.dart';
import 'internal/klp_flutter_workspace_block.dart';
import 'internal/klp_flutter_anchored_popup.dart';
...
final class KlpFlutterRenderer extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		...
		return switch (content) {
			KlpBoundMenu value => KlpFlutterMenu(content: value),
			...
			KlpBoundAnchoredPopup value => KlpFlutterAnchoredPopup(content: value),
