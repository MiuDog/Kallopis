...
final class KlpFlutterExtent extends StatelessWidget {
	...
	Widget _layout(BuildContext context, BoxConstraints constraints) {
		...
		final crossMaximum = horizontal ? constraints.maxHeight : constraints.maxWidth;
		final crossExtent = crossMaximum.isFinite ? crossMaximum : null;
		final child = SizedBox(width: horizontal ? extent : crossExtent, height: horizontal ? crossExtent : extent, child: KlpFlutterRenderer(content: content.child));
