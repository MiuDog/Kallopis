	...
	Widget build(BuildContext context) {
		...
		for (final child in content.children) {
			if (children.isNotEmpty) {
				children.add(SizedBox(width: axis == Axis.horizontal ? content.gap.value : null, height: axis == Axis.vertical ? content.gap.value : null));
			}
		...
		return SingleChildScrollView(scrollDirection: axis, primary: false, child: flow);
	}
}
