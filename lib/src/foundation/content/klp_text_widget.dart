	...
	Widget build(BuildContext context) {
		...
		final style = roleStyle.copyWith(
			...
			letterSpacing: switch (tracking) {
				KlpTextTracking.placeholder => context.klp.geometry.data.placeholderLabelTracking,
				null => null,
			},
		);
		...
		final rendered = applyOpticalShift ? _KlpOpticalShift(offsetY: yOffset, child: text) : text;
