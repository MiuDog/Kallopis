	...
	Widget build(BuildContext context) {
		...
		return Semantics(
			...
			child: KlpPressable(
				...
				child: SizedBox(
					width: context.klp.geometry.control.switchTrackWidth,
					height: context.klp.geometry.control.switchTrackHeight,
					child: DecoratedBox(
							...
							child: Padding(
								...
								child: DecoratedBox(
									...
									child: SizedBox.square(
										dimension: context.klp.geometry.control.switchThumb,
									),
								),
							),
						),
