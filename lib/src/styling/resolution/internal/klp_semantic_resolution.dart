...
final class KlpSemanticResolution {
	...
	KlpSemanticResolution(Map<(String, String), KlpStyleValue> values) : _values = Map.unmodifiable(values);
	...
	T read<T extends KlpStyleValue>(KlpSemanticKey<T> key) {
		...
		if (!key.kind.accepts(value)) throw KlpContractError('semantic_kind_mismatch', key.path);
