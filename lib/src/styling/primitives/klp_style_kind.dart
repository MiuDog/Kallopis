...
final class KlpStyleKind<T extends KlpStyleValue> {
  ...
  static const KlpStyleKind<KlpStrokeWidth> strokeWidth = KlpStyleKind._(
    'strokeWidth',
  );
  static const KlpStyleKind<KlpFontSize> fontSize = KlpStyleKind._('fontSize');
  static const KlpStyleKind<KlpFontWeight> fontWeight = KlpStyleKind._(
    'fontWeight',
  );
  static const KlpStyleKind<KlpLineHeight> lineHeight = KlpStyleKind._(
    'lineHeight',
  );
  static const KlpStyleKind<KlpLetterSpacing> letterSpacing = KlpStyleKind._(
    'letterSpacing',
  );
  static const KlpStyleKind<KlpDuration> duration = KlpStyleKind._('duration');
  static const KlpStyleKind<KlpFontFamily> fontFamily = KlpStyleKind._(
    'fontFamily',
  );
