...
class KlpLayoutGeometry {
	...
	KlpLayoutGeometry copyWith({
		...
		primaryPaneContentBreakpoint: primaryPaneContentBreakpoint ?? this.primaryPaneContentBreakpoint,
		responsivePaneBreakpoint: responsivePaneBreakpoint ?? this.responsivePaneBreakpoint,
		secondaryPaneBreakpoint: secondaryPaneBreakpoint ?? this.secondaryPaneBreakpoint,
		...
		inlineNoticeBreakpoint: inlineNoticeBreakpoint ?? this.inlineNoticeBreakpoint,
		statusBarBreakpoint: statusBarBreakpoint ?? this.statusBarBreakpoint,
		settingsDialogMaximumWidth: settingsDialogMaximumWidth ?? this.settingsDialogMaximumWidth,
		settingsDialogMaximumHeight: settingsDialogMaximumHeight ?? this.settingsDialogMaximumHeight,
		settingsPaneGap: settingsPaneGap ?? this.settingsPaneGap,
		settingsNavigationWidth: settingsNavigationWidth ?? this.settingsNavigationWidth,
		settingsNavigationMinimumWidth: settingsNavigationMinimumWidth ?? this.settingsNavigationMinimumWidth,
		settingsNavigationMaximumWidth: settingsNavigationMaximumWidth ?? this.settingsNavigationMaximumWidth,
		settingsContentMaximumWidth: settingsContentMaximumWidth ?? this.settingsContentMaximumWidth,
		...
		windowHeaderControlSize: windowHeaderControlSize ?? this.windowHeaderControlSize,
