...
class KlpComponentTheme extends ThemeExtension<KlpComponentTheme> {
	...
	double resolveButtonHeight(KlpControlGeometry geometry) =>
		buttonHeight ?? geometry.buttonHeight;
	...
	double resolveFieldPaddingX(KlpSpacingTheme s) => fieldPaddingX ?? s.controlInset;
	...
	double resolveMenuPadding(KlpSpacingTheme s) => menuPadding ?? s.overlayContentInset;
	...
	double resolveBadgePaddingX(KlpSpacingTheme spacing) =>
		badgePaddingX ?? spacing.tight + spacing.xxs;
