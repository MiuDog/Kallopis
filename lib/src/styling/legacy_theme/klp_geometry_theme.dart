...
class KlpGeometryTheme extends ThemeExtension<KlpGeometryTheme> {
  ...
  static const KlpGeometryTheme standard = KlpGeometryTheme(
    control: KlpControlGeometry(
      buttonHeightXSmall: 28,
      buttonHeightSmall: 32,
      buttonHeight: 36,
      buttonHeightLarge: 40,
      buttonHeightXLarge: 48,
      ...
      segmentedDenseContentInset: KlpControlMetrics.segmentedDenseContentInset,
      segmentedDenseItemHeight: KlpSize.segmentedDenseItem,
      slidingSelectionHeight: KlpControlMetrics.slidingSelectionHeight,
      slidingSelectionSegmentWidth:
          KlpControlMetrics.slidingSelectionSegmentWidth,
      slidingSelectionPadding: KlpControlMetrics.slidingSelectionPadding,
      slidingSelectionIndicatorHeight:
          KlpControlMetrics.slidingSelectionIndicatorHeight,
      scrollbarThickness: KlpControlMetrics.scrollbarThickness,
      sliderTrackHeight: 4,
      colorPlaneExtent: 168,
      textFieldIndicatorHeightFactor: 0.4,
      textFieldLineHeightFactor: 1.3,
      textFieldMinLines: 4,
      textFieldMaxLines: 8,
      fileExplorerRowHeightAdjustment: 0,
    ),
    data: KlpDataGeometry(
      ...
      filePreviewHeight: 220,
      previewCardCompactHeight: KlpScale.space1600,
      previewCardStandardHeight: KlpScale.space2400,
      previewCardLargeHeight: 192,
      dateGridCellHeight: 128,
      keyValueLabelWidthCompact: 96,
      keyValueLabelWidthStandard: 112,
      stepperMarkerSize: KlpScale.space600,
      stepperLabelWidth: 60,
      progressIndeterminateFraction: 0.35,
    ...
    layout: KlpLayoutGeometry(
      ...
      windowHeaderControlSize: 24,
      windowAppIconSize: 20,
