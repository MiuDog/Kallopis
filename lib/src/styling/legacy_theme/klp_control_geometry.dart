...
class KlpControlGeometry {
  ...
  KlpControlGeometry copyWith({
    ...
    pageBackgroundHitRadius:
        pageBackgroundHitRadius ?? this.pageBackgroundHitRadius,
    presenceMarkerExtent: presenceMarkerExtent ?? this.presenceMarkerExtent,
    colorPickerCursorRadius:
        colorPickerCursorRadius ?? this.colorPickerCursorRadius,
    swatchExtent: swatchExtent ?? this.swatchExtent,
    segmentedProgressHeight:
        segmentedProgressHeight ?? this.segmentedProgressHeight,
    ...
    selectionIndicatorInset:
        selectionIndicatorInset ?? this.selectionIndicatorInset,
    ...
    segmentedDenseContentInset:
        segmentedDenseContentInset ?? this.segmentedDenseContentInset,
    segmentedDenseItemHeight:
        segmentedDenseItemHeight ?? this.segmentedDenseItemHeight,
    slidingSelectionHeight:
        slidingSelectionHeight ?? this.slidingSelectionHeight,
    slidingSelectionSegmentWidth:
        slidingSelectionSegmentWidth ?? this.slidingSelectionSegmentWidth,
    slidingSelectionPadding:
        slidingSelectionPadding ?? this.slidingSelectionPadding,
    slidingSelectionIndicatorHeight:
        slidingSelectionIndicatorHeight ?? this.slidingSelectionIndicatorHeight,
    ...
    textFieldIndicatorHeightFactor:
        textFieldIndicatorHeightFactor ?? this.textFieldIndicatorHeightFactor,
    textFieldLineHeightFactor:
        textFieldLineHeightFactor ?? this.textFieldLineHeightFactor,
    ...
    fileExplorerRowHeightAdjustment:
        fileExplorerRowHeightAdjustment ?? this.fileExplorerRowHeightAdjustment,
  );
  ...
  bool operator ==(Object other) =>
      ...
      other is KlpControlGeometry &&
          ...
          slidingSelectionIndicatorHeight ==
              other.slidingSelectionIndicatorHeight &&
