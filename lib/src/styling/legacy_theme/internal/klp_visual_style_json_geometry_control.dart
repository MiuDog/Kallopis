import 'package:kallopis/src/styling/legacy_theme/klp_control_geometry.dart';
...
KlpControlGeometry decodeControlGeometry(
  ...
  return KlpControlGeometry(
    ...
    pageBackgroundHitRadius: read(
      'pageBackgroundHitRadius',
      base.pageBackgroundHitRadius,
    ),
    presenceMarkerExtent: read(
      'presenceMarkerExtent',
      base.presenceMarkerExtent,
    ),
    colorPickerCursorRadius: read(
      'colorPickerCursorRadius',
      base.colorPickerCursorRadius,
    ),
    swatchExtent: read('swatchExtent', base.swatchExtent),
    segmentedProgressHeight: read(
      'segmentedProgressHeight',
      base.segmentedProgressHeight,
    ),
    ...
    segmentedDenseContentInset: read(
      'segmentedDenseContentInset',
      base.segmentedDenseContentInset,
    ),
    segmentedDenseItemHeight: read(
      'segmentedDenseItemHeight',
      base.segmentedDenseItemHeight,
    ),
    slidingSelectionHeight: read(
      'slidingSelectionHeight',
      base.slidingSelectionHeight,
    ),
    slidingSelectionSegmentWidth: read(
      'slidingSelectionSegmentWidth',
      base.slidingSelectionSegmentWidth,
    ),
    slidingSelectionPadding: read(
      'slidingSelectionPadding',
      base.slidingSelectionPadding,
    ),
    slidingSelectionIndicatorHeight: read(
      'slidingSelectionIndicatorHeight',
      base.slidingSelectionIndicatorHeight,
    ),
