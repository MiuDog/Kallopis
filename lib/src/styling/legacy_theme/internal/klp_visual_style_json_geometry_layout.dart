...
KlpLayoutGeometry decodeLayoutGeometry(
	...
	return KlpLayoutGeometry(
		...
		resizeHandleExtent: read('resizeHandleExtent', base.resizeHandleExtent),
		overlayViewportInset: read('overlayViewportInset', base.overlayViewportInset),
		railDropTargetExtent: read('railDropTargetExtent', base.railDropTargetExtent),
		disclosureIconSize: read('disclosureIconSize', base.disclosureIconSize),
		treeLeadingGap: read('treeLeadingGap', base.treeLeadingGap),
		tooltipOffsetX: read('tooltipOffsetX', base.tooltipOffsetX),
		...
		responsivePaneBreakpoint: read(
			'responsivePaneBreakpoint',
			base.responsivePaneBreakpoint,
		),
		...
		commandMenuWidth: read('commandMenuWidth', base.commandMenuWidth),
