...
KlpSurfaceTheme decodeSurface(KlpJsonMap json, KlpSurfaceTheme base) {
	...
	return base.copyWith(
		...
		dragSourceOpacity: alpha('dragSourceOpacity', base.dragSourceOpacity),
		themePreviewDisabledOpacity: alpha(
			'themePreviewDisabledOpacity',
			base.themePreviewDisabledOpacity,
		),
		...
		contactBlur: size('contactBlur', base.contactBlur),
		contactOffsetY: readDouble(json, 'contactOffsetY', path, base.contactOffsetY),
		contactShadowOpacity: alpha('contactShadowOpacity', base.contactShadowOpacity),
		overlayShadowColor: readColor(json, 'overlayShadowColor', path, base.overlayShadowColor),
	);
}
...
KlpJsonMap encodeSurface(KlpSurfaceTheme v) => <String, Object?>{
	...
	'dragSourceOpacity': v.dragSourceOpacity,
	'themePreviewDisabledOpacity': v.themePreviewDisabledOpacity,
	...
	'invalidFillOpacity': v.invalidFillOpacity,
		'contactBlur': v.contactBlur,
		'contactOffsetY': v.contactOffsetY,
		'contactShadowOpacity': v.contactShadowOpacity,
		'overlayShadowColor': encodeColor(v.overlayShadowColor),
};
