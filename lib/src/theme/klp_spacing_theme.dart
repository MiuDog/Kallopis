...
class KlpSpacingTheme extends ThemeExtension<KlpSpacingTheme> {
	const KlpSpacingTheme({
		...
		required this.tight,
		this.contentInlineGap = KlpScale.space200,
		this.contentStackGap = KlpScale.space200,
		this.contentInset = KlpScale.space200,
		this.controlContentGap = KlpScale.space200,
		this.controlInset = KlpScale.space200,
		this.actionGap = KlpScale.space200,
		this.chromeGap = KlpScale.space200,
		this.chromePanelInset = KlpScale.space200,
		this.chromeToolbarGap = KlpScale.space200,
		this.navigationItemInset = KlpScale.space200,
		this.navigationRailInset = KlpScale.space200,
		this.navigationRailItemGap = KlpScale.space200,
		this.overlayContentInset = KlpScale.space200,
		this.overlayHeadingGap = KlpScale.space200,
	...
	final double tight;
	final double contentInlineGap;
	final double contentStackGap;
	final double contentInset;
	final double controlContentGap;
	final double controlInset;
	final double actionGap;
	final double chromeGap;
	final double chromePanelInset;
	final double chromeToolbarGap;
	final double navigationItemInset;
	final double navigationRailInset;
	final double navigationRailItemGap;
	final double overlayContentInset;
	final double overlayHeadingGap;
	...
	KlpSpacingTheme copyWith({
		...
		double? hairline,
		double? tight,
		double? contentInlineGap,
		double? contentStackGap,
		double? contentInset,
		double? controlContentGap,
		double? controlInset,
		double? actionGap,
		double? chromeGap,
		double? chromePanelInset,
		double? chromeToolbarGap,
		double? navigationItemInset,
		double? navigationRailInset,
		double? navigationRailItemGap,
		double? overlayContentInset,
		double? overlayHeadingGap,
		...
		return KlpSpacingTheme(
			...
			contentInlineGap: contentInlineGap ?? this.contentInlineGap,
			contentStackGap: contentStackGap ?? this.contentStackGap,
			contentInset: contentInset ?? this.contentInset,
			controlContentGap: controlContentGap ?? this.controlContentGap,
			controlInset: controlInset ?? this.controlInset,
			actionGap: actionGap ?? this.actionGap,
			chromeGap: chromeGap ?? this.chromeGap,
			chromePanelInset: chromePanelInset ?? this.chromePanelInset,
			chromeToolbarGap: chromeToolbarGap ?? this.chromeToolbarGap,
			navigationItemInset: navigationItemInset ?? this.navigationItemInset,
			navigationRailInset: navigationRailInset ?? this.navigationRailInset,
			navigationRailItemGap: navigationRailItemGap ?? this.navigationRailItemGap,
			overlayContentInset: overlayContentInset ?? this.overlayContentInset,
			overlayHeadingGap: overlayHeadingGap ?? this.overlayHeadingGap,
			...
			workbenchContentInset: workbenchContentInset ?? this.workbenchContentInset,
	...
	bool operator ==(Object other) =>
			...
			other is KlpSpacingTheme &&
					...
					tight == other.tight &&
					contentInlineGap == other.contentInlineGap &&
					contentStackGap == other.contentStackGap &&
					contentInset == other.contentInset &&
					controlContentGap == other.controlContentGap &&
					controlInset == other.controlInset &&
					actionGap == other.actionGap &&
					chromeGap == other.chromeGap &&
					chromePanelInset == other.chromePanelInset &&
					chromeToolbarGap == other.chromeToolbarGap &&
					navigationItemInset == other.navigationItemInset &&
					navigationRailInset == other.navigationRailInset &&
					navigationRailItemGap == other.navigationRailItemGap &&
					overlayContentInset == other.overlayContentInset &&
					overlayHeadingGap == other.overlayHeadingGap &&
