...
@immutable
class PlnDataVisualizationTheme
    extends ThemeExtension<PlnDataVisualizationTheme> {
  const PlnDataVisualizationTheme({
  ...
  static const light = PlnDataVisualizationTheme(
    series: [
      Color(0xFFE0BE73),
      Color(0xFFD3A152),
      Color(0xFFC6823D),
  ...
  static const dark = PlnDataVisualizationTheme(
    series: [
      Color(0xFFF0D79A),
      Color(0xFFE8BD70),
      Color(0xFFDFA04E),
  ...
  static const ultraDark = PlnDataVisualizationTheme(
    series: [
      Color(0xFFF0D79A),
      Color(0xFFE8BD70),
      Color(0xFFDFA04E),
  ...
  @override
  PlnDataVisualizationTheme copyWith({
    List<Color>? series,
    ...
    return PlnDataVisualizationTheme(
  ...
  @override
  PlnDataVisualizationTheme lerp(
    covariant PlnDataVisualizationTheme? other,
    double t,
  ) {
...
extension PlnDataVisualizationThemeContext on BuildContext {
  PlnDataVisualizationTheme get plnDataVisualizationTheme {
    return Theme.of(this).extension<PlnDataVisualizationTheme>() ??
