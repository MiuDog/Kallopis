...
import '../../controls/selection/klp_checkbox.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Widget rowContent = Container(
      constraints: BoxConstraints(minHeight: context.klp.space.controlHeight),
			padding: EdgeInsets.symmetric(horizontal: context.klp.space.controlInset),
      decoration: BoxDecoration(
    ...
    return Padding(
			padding: EdgeInsets.only(left: context.klp.geometry.layout.treeLeadingGap),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          row,
          ...
          children: [
            ColoredBox(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                  horizontal: context.klp.space.base,
									vertical: context.klp.space.contentInset,
                ),
                child: Row(
                  children: [
                    Expanded(
