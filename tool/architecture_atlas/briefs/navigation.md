...
| Explorer 與 Rail 各自從哪裡開始？ | 通用 `KlpExplorer` 已移至 lib/src/features/workspace/explorer/klp_explorer.dart；本導覽目錄只保留另一個 Stable `KlpFileExplorer`；`KlpNavigationRail`：lib/src/features/navigation/widgets/rail/klp_navigation_rail.dart:13 |
