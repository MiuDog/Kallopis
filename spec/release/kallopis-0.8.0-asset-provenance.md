...
Kallopis 的所有介面圖示使用 Flaticon UIcons 的 Regular Rounded 與 Thin Rounded 字型，
...
- 使用風格：Regular Rounded（CSS prefix `fi-rr`）與 Thin Rounded（CSS prefix `fi-tr`）
- 原始 webfont：`uicons-regular-rounded-J3WOUERV.woff2`、`uicons-thin-rounded-HOOVQNVT.woff2`
- Flutter 資產：`assets/fonts/FlaticonUIcons-RegularRounded.ttf`、`assets/fonts/FlaticonUIcons-ThinRounded.ttf`
- Regular TTF SHA-256：`e718df7cfcea3e10b7307ff9c3689102d3b73252a6d6e73f43e25503f68e4cf5`
- Thin TTF SHA-256：`bd9e209ffde3b2bdf3df95776ac37c92cdeecc6a4eb79d1d63fddc70cf9c29dd`
...
Thin Rounded 的免費字集未提供全部 Regular Rounded 同名 glyph。`KlpIconData` 只為已核對的同名圖示登記 Thin 字碼；元件要求 Thin 但沒有對應字碼時，必須回退同一圖形的 Regular Rounded，不可改用其他圖形。
