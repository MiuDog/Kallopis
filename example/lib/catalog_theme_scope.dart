...
class CatalogThemeScope extends InheritedWidget {
  ...
  static CatalogThemeScope of(BuildContext context) {
    final scope = context
        .dependOnInheritedWidgetOfExactType<CatalogThemeScope>();
    assert(
      scope != null,
      'CatalogThemeScope is missing above this Catalog page.',
    );
    return scope!;
  }

  @override
  bool updateShouldNotify(CatalogThemeScope oldWidget) =>
