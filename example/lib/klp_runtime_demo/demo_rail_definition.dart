...
KlpComponentDefinition<DemoRailItem> demoRailDefinition() {
  ...
  final semantics = KlpSemanticSchema(DemoRailItem.typeId, [
    ...
    KlpSemanticToken(
      size,
      const KlpPrimitiveRef(KlpStyleKind.fontSize, KlpPrimitiveIndex.i1),
    ),
    KlpSemanticToken(
      weight,
    ...
    KlpSemanticToken(
      spacing,
      const KlpPrimitiveRef(KlpStyleKind.letterSpacing, KlpPrimitiveIndex.i3),
    ),
    KlpSemanticToken(
      gap,
  ...
  return KlpComponentDefinition(
    DemoRailItem.typeId,
    semantics: semantics,
    content: KlpLinearTemplate<DemoRailItem>(
      axis: KlpAxis.horizontal,
      gap: gap,
      children: [
        KlpTextTemplate<DemoRailItem>(
        ...
        KlpChildrenTemplate<DemoRailItem, DemoCounterContent>(
          slot: DemoRailItem.counterSlot,
          axis: KlpAxis.horizontal,
          gap: gap,
        ),
      ],
