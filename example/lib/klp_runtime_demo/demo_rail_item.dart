...
final class DemoRailItem implements KlpRailItem, KlpCompositeNode {
	...
	static final counterSlot = KlpSlot<DemoCounterContent>(owner: typeId, name: 'counter', min: 1, max: 1);
	...
	DemoRailItem({required this.id, required this.label, required this.counter, required this.action}) : children = KlpChildren([counterSlot.assign([counter])]);
