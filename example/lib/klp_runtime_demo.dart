...
void main() {
  ...
  KlpApplication declaration() {
    return KlpApplication(
      title:
          'Klp router demo | A: count/result | B: open/back | C: style | $lastAction / $count',
      ...
      router: KlpRouter(
        ...
        routes: [
              ...
              child: KlpRail(
                ...
                top: [
                  DemoRailItem(
                    id: 'a',
                    label: 'A',
                    counter: DemoCounter(id: 'a.counter', value: count),
                    action: KlpCallbackAction(() => activate('A')),
                  ),
                ],
                center: [
                  DemoRailItem(
                    id: 'b',
                    label: 'B',
                    counter: DemoCounter(id: 'b.counter', value: count),
                    action: input.navigate(
                      details.location(count),
                      onResult: (value) {
                        count = value;
                        lastAction = 'result';
                ...
                bottom: [
                  DemoRailItem(
                    id: 'c',
                    label: 'C',
                    counter: DemoCounter(id: 'c.counter', value: count),
                    action: KlpCallbackAction(() => activate('C')),
                  ),
                ],
              ),
            ),
          ...
          KlpRoute<int, int>(
            ...
            screen: (input) => KlpScreen(
              id: 'demo.screen',
              accessibilityLabel: 'Demo details',
              child: KlpRail(
                id: 'demo.rail',
                top: [
                  DemoRailItem(
                    ...
                    action: input.finish(input.parameters + 1),
                  ),
                ],
                center: [
                  DemoRailItem(
