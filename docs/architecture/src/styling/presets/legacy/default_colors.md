...
[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/styling/presets/legacy/default_colors.dart)

## 範圍

核心是 `lib/src/styling/presets/legacy/default_colors.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
flowchart TD
	...
	n1["../../legacy_theme/klp_theme_data.dart"]
	n0 -->|"part of"| n1
```
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;../../legacy_theme/klp_theme_data.dart&#x27;;</code> | [lib/src/styling/presets/legacy/default_colors.dart:1](../../../../../../lib/src/styling/presets/legacy/default_colors.dart#L1) |
...
top-level variable · private · [lib/src/styling/presets/legacy/default_colors.dart:5](../../../../../../lib/src/styling/presets/legacy/default_colors.dart#L5)
