...
flowchart TD
	n0["klp_flutter_renderer.dart"]
	n1["internal/klp_flutter_workspace_block.dart"]
	n0 -->|"import"| n1
```
...
| import | <code>import &#x27;internal/klp_flutter_workspace_block.dart&#x27;;</code> | [lib/src/rendering/flutter/klp_flutter_renderer.dart:24](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L24) |
...
ClassDeclaration · public · [lib/src/rendering/flutter/klp_flutter_renderer.dart:26](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L26)

<code>final class KlpFlutterRenderer extends StatelessWidget</code>

來源註解摘要：唯一封閉的 Flutter 呈現分派；不接受消費端 Widget 或 builder。

- `extends` → <code>StatelessWidget</code>：[lib/src/rendering/flutter/klp_flutter_renderer.dart:27](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L27)

| 成員 | 可見性 | 簽章／型別 | 來源註解摘要 | 證據 |
|---|---|---|---|---|
| field <code>content</code> | public | <code>final KlpBoundTemplate content</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:28](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L28) |
| constructor <code>KlpFlutterRenderer</code> | public | <code>KlpFlutterRenderer({required this.content, Key? key})</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:30](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L30) |
| method <code>_placementKey</code> | private | <code>static Key? _placementKey(KlpBoundTemplate content)</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:33](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L33) |
| method <code>build</code> | public | <code>Widget build(BuildContext context)</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:39](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L39) |
| method <code>_surface</code> | private | <code>Widget _surface(KlpBoundSurface value)</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:86](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L86) |
| method <code>_scopeId</code> | private | <code>KlpId _scopeId(KlpPlacementId placement)</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:118](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L118) |

### _KlpFlutterOverlayHost

ClassDeclaration · private · [lib/src/rendering/flutter/klp_flutter_renderer.dart:127](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L127)

<code>final class _KlpFlutterOverlayHost extends StatefulWidget</code>

來源註解摘要：由完整畫面持有浮層，讓選單、對話框與拖曳回饋不受局部元件邊界裁切。

- `extends` → <code>StatefulWidget</code>：[lib/src/rendering/flutter/klp_flutter_renderer.dart:128](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L128)

| 成員 | 可見性 | 簽章／型別 | 來源註解摘要 | 證據 |
|---|---|---|---|---|
| field <code>child</code> | public | <code>final Widget child</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:129](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L129) |
| constructor <code>_KlpFlutterOverlayHost</code> | private | <code>const _KlpFlutterOverlayHost({required this.child})</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:130](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L130) |
| method <code>createState</code> | public | <code>State&lt;_KlpFlutterOverlayHost&gt; createState()</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:131](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L131) |

### _KlpFlutterOverlayHostState

ClassDeclaration · private · [lib/src/rendering/flutter/klp_flutter_renderer.dart:135](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L135)

<code>final class _KlpFlutterOverlayHostState extends State&lt;_KlpFlutterOverlayHost&gt;</code>

- `extends` → <code>State&lt;_KlpFlutterOverlayHost&gt;</code>：[lib/src/rendering/flutter/klp_flutter_renderer.dart:135](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L135)

| 成員 | 可見性 | 簽章／型別 | 來源註解摘要 | 證據 |
|---|---|---|---|---|
| field <code>_content</code> | private | <code>late final (inferred) _content</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:136](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L136) |
| method <code>didUpdateWidget</code> | public | <code>void didUpdateWidget(_KlpFlutterOverlayHost oldWidget)</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:137](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L137) |
| method <code>dispose</code> | public | <code>void dispose()</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:142](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L142) |
| method <code>build</code> | public | <code>Widget build(BuildContext context)</code> |  | [lib/src/rendering/flutter/klp_flutter_renderer.dart:147](../../../../../lib/src/rendering/flutter/klp_flutter_renderer.dart#L147) |
