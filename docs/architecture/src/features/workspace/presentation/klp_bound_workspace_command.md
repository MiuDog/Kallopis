...
| field <code>onInvoke</code> | public | <code>final FutureOr&lt;void&gt; Function(String?) onInvoke</code> |  | [lib/src/features/workspace/presentation/klp_bound_workspace_command.dart:15](../../../../../../lib/src/features/workspace/presentation/klp_bound_workspace_command.dart#L15) |
| field <code>onResult</code> | public | <code>final void Function(KlpWorkspaceCommandResult)? onResult</code> |  | [lib/src/features/workspace/presentation/klp_bound_workspace_command.dart:16](../../../../../../lib/src/features/workspace/presentation/klp_bound_workspace_command.dart#L16) |
| constructor <code>KlpBoundWorkspaceCommand</code> | public | <code>const KlpBoundWorkspaceCommand({required this.label, required this.enabled, required this.destructive, this.inputLabel, this.initialValue, this.confirmation, required this.submitLabel, required this.cancelLabel, this.shortcut, required this.onInvoke, this.onResult})</code> |  | [lib/src/features/workspace/presentation/klp_bound_workspace_command.dart:17](../../../../../../lib/src/features/workspace/presentation/klp_bound_workspace_command.dart#L17) |
| constructor <code>fromCommand</code> | public | <code>factory KlpBoundWorkspaceCommand.fromCommand(KlpWorkspaceCommand command)</code> |  | [lib/src/features/workspace/presentation/klp_bound_workspace_command.dart:19](../../../../../../lib/src/features/workspace/presentation/klp_bound_workspace_command.dart#L19) |
