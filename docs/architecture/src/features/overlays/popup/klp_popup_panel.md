# klp_popup_panel.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/features/overlays/popup/klp_popup_panel.dart)

## 範圍

核心是 `lib/src/features/overlays/popup/klp_popup_panel.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_popup_panel.dart"]
	n1["../klp_popup.dart"]
	n0 -->|"part of"| n1
```
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;../klp_popup.dart&#x27;;</code> | [lib/src/features/overlays/popup/klp_popup_panel.dart:1](../../../../../../lib/src/features/overlays/popup/klp_popup_panel.dart#L1) |
...
ClassDeclaration · public · [lib/src/features/overlays/popup/klp_popup_panel.dart:3](../../../../../../lib/src/features/overlays/popup/klp_popup_panel.dart#L3)

<code>class KlpPopupPanel extends StatelessWidget</code>

來源註解摘要：Popup 的固定尺寸 surface。內容內距由 [child] 自己擁有。

- `extends` → <code>StatelessWidget</code>：[lib/src/features/overlays/popup/klp_popup_panel.dart:4](../../../../../../lib/src/features/overlays/popup/klp_popup_panel.dart#L4)
