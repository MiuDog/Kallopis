# klp_popup_interaction_scope.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/features/overlays/popup/klp_popup_interaction_scope.dart)

## 範圍

核心是 `lib/src/features/overlays/popup/klp_popup_interaction_scope.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_popup_interaction_scope.dart"]
	n1["../klp_popup.dart"]
	n0 -->|"part of"| n1
```
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;../klp_popup.dart&#x27;;</code> | [lib/src/features/overlays/popup/klp_popup_interaction_scope.dart:1](../../../../../../lib/src/features/overlays/popup/klp_popup_interaction_scope.dart#L1) |
...
ClassDeclaration · public · [lib/src/features/overlays/popup/klp_popup_interaction_scope.dart:3](../../../../../../lib/src/features/overlays/popup/klp_popup_interaction_scope.dart#L3)

<code>class KlpPopupInteractionScope extends InheritedWidget</code>

來源註解摘要：供 App frame 注入視窗標題列保留範圍。

- `extends` → <code>InheritedWidget</code>：[lib/src/features/overlays/popup/klp_popup_interaction_scope.dart:4](../../../../../../lib/src/features/overlays/popup/klp_popup_interaction_scope.dart#L4)
