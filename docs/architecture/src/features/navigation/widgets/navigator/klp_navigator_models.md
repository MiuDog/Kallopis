...
[回到目錄](README.md) · [來源檔案](../../../../../../../lib/src/features/navigation/widgets/navigator/klp_navigator_models.dart)

## 範圍

核心是 `lib/src/features/navigation/widgets/navigator/klp_navigator_models.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
flowchart LR
	...
	n6["models/klp_navigator_item.dart"]
	n0 -->|"import"| n1
	n0 -->|"import"| n2
	n0 -->|"part"| n3
	n0 -->|"part"| n4
...
| part | <code>part &#x27;models/klp_navigator_item.dart&#x27;;</code> | [lib/src/features/navigation/widgets/navigator/klp_navigator_models.dart:8](../../../../../../../lib/src/features/navigation/widgets/navigator/klp_navigator_models.dart#L8) |
