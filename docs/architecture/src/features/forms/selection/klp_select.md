...
[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/features/forms/selection/klp_select.dart)

## 範圍

核心是 `lib/src/features/forms/selection/klp_select.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
flowchart LR
	...
	n11["primitives/klp_select_action_frame.dart"]
	n0 -->|"import"| n1
	n0 -->|"import"| n2
	n0 -->|"import"| n3
	n0 -->|"import"| n4
...
| part | <code>part &#x27;primitives/klp_select_action_frame.dart&#x27;;</code> | [lib/src/features/forms/selection/klp_select.dart:13](../../../../../../lib/src/features/forms/selection/klp_select.dart#L13) |
