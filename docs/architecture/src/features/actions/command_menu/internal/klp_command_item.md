...
[回到目錄](README.md) · [來源檔案](../../../../../../../lib/src/features/actions/command_menu/internal/klp_command_item.dart)

## 範圍

核心是 `lib/src/features/actions/command_menu/internal/klp_command_item.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;../klp_command_menu.dart&#x27;;</code> | [lib/src/features/actions/command_menu/internal/klp_command_item.dart:1](../../../../../../../lib/src/features/actions/command_menu/internal/klp_command_item.dart#L1) |
...
ClassDeclaration · private · [lib/src/features/actions/command_menu/internal/klp_command_item.dart:3](../../../../../../../lib/src/features/actions/command_menu/internal/klp_command_item.dart#L3)

<code>class _KlpCommandItem extends StatelessWidget</code>

- `extends` → <code>StatelessWidget</code>：[lib/src/features/actions/command_menu/internal/klp_command_item.dart:3](../../../../../../../lib/src/features/actions/command_menu/internal/klp_command_item.dart#L3)
