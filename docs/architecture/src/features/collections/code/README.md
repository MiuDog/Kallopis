# lib/src/features/collections/code：架構分析入口

[上一層](../README.md)

## 範圍

閱讀 `lib/src/features/collections/code` 的直接子目錄與 Dart 檔案。結構圖表示實際檔案包含關係；依賴圖表示本層檔案明寫的 directives。每個檔案頁另列直接依賴、宣告、欄位、方法、建構子及行號證據。
...
| <code>lib/src/features/overlays</code> | import | 2 | [lib/src/features/collections/code/klp_code_viewer.dart:8](../../../../../../lib/src/features/collections/code/klp_code_viewer.dart#L8) |
| <code>lib/src/foundation</code> | import | 2 | [lib/src/features/collections/code/klp_code_viewer.dart:3](../../../../../../lib/src/features/collections/code/klp_code_viewer.dart#L3) |
...
| 來源 → 目標 | 關係 | 證據 |
|---|---|---|
| <code>klp_code_viewer.dart → klp_code_viewport_limit.dart</code> | part | [lib/src/features/collections/code/klp_code_viewer.dart:23](../../../../../../lib/src/features/collections/code/klp_code_viewer.dart#L23) |
| <code>klp_code_viewport_limit.dart → klp_code_viewer.dart</code> | part of | [lib/src/features/collections/code/klp_code_viewport_limit.dart:1](../../../../../../lib/src/features/collections/code/klp_code_viewport_limit.dart#L1) |
...
flowchart LR
	...
	n2["models/"]
	n3["primitives/"]
	n4["klp_code_viewer.dart"]
	n5["klp_code_viewport_limit.dart"]
	n0 -->|"contains"| n1
	n0 -->|"contains"| n2
	n0 -->|"contains"| n3
	n0 -->|"contains"| n4
...
| 目錄 | 導航 | 來源證據 |
|---|---|---|
| `internal/` | [架構入口](internal/README.md) | [來源目錄](../../../../../../lib/src/features/collections/code/internal) |
| `models/` | [架構入口](models/README.md) | [來源目錄](../../../../../../lib/src/features/collections/code/models) |
| `primitives/` | [架構入口](primitives/README.md) | [來源目錄](../../../../../../lib/src/features/collections/code/primitives) |

## 本層檔案

| 檔案 | 宣告 | 細節 | 來源證據 |
|---|---|---|---|
| `klp_code_viewer.dart` | 無頂層宣告 | [架構與 API](klp_code_viewer.md) | [lib/src/features/collections/code/klp_code_viewer.dart:1](../../../../../../lib/src/features/collections/code/klp_code_viewer.dart#L1) |
| `klp_code_viewport_limit.dart` | KlpCodeViewportLimit | [架構與 API](klp_code_viewport_limit.md) | [lib/src/features/collections/code/klp_code_viewport_limit.dart:1](../../../../../../lib/src/features/collections/code/klp_code_viewport_limit.dart#L1) |
