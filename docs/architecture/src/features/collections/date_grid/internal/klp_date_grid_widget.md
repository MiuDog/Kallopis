# klp_date_grid_widget.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../../../lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart)

## 範圍

核心是 `lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_date_grid_widget.dart"]
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;../klp_date_grid.dart&#x27;;</code> | [lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart:1](../../../../../../../lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart#L1) |
...
ClassDeclaration · public · [lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart:3](../../../../../../../lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart#L3)

<code>class KlpDateGrid extends StatelessWidget</code>

來源註解摘要：一列七欄的日期概覽格。

- `extends` → <code>StatelessWidget</code>：[lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart:4](../../../../../../../lib/src/features/collections/date_grid/internal/klp_date_grid_widget.dart#L4)
