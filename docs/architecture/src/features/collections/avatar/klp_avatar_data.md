# klp_avatar_data.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/features/collections/avatar/klp_avatar_data.dart)

## 範圍

核心是 `lib/src/features/collections/avatar/klp_avatar_data.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_avatar_data.dart"]
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| import | <code>import &#x27;package:flutter/widgets.dart&#x27;;</code> | [lib/src/features/collections/avatar/klp_avatar_data.dart:1](../../../../../../lib/src/features/collections/avatar/klp_avatar_data.dart#L1) |
...
ClassDeclaration · public · [lib/src/features/collections/avatar/klp_avatar_data.dart:3](../../../../../../lib/src/features/collections/avatar/klp_avatar_data.dart#L3)

<code>class KlpAvatarData</code>

來源註解摘要：Avatar 群組使用的無產品語意資料。
