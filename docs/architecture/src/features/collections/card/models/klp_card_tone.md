# klp_card_tone.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../../../lib/src/features/collections/card/models/klp_card_tone.dart)

## 範圍

核心是 `lib/src/features/collections/card/models/klp_card_tone.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_card_tone.dart"]
	n1["../klp_card.dart"]
	n0 -->|"part of"| n1
```
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;../klp_card.dart&#x27;;</code> | [lib/src/features/collections/card/models/klp_card_tone.dart:1](../../../../../../../lib/src/features/collections/card/models/klp_card_tone.dart#L1) |
...
EnumDeclaration · public · [lib/src/features/collections/card/models/klp_card_tone.dart:3](../../../../../../../lib/src/features/collections/card/models/klp_card_tone.dart#L3)

<code>enum KlpCardTone</code>

來源註解摘要：內容卡片可採用的中性表面層級。
