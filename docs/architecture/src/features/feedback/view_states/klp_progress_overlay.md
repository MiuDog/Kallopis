# klp_progress_overlay.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/features/feedback/view_states/klp_progress_overlay.dart)

## 範圍

核心是 `lib/src/features/feedback/view_states/klp_progress_overlay.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_progress_overlay.dart"]
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;klp_view_states.dart&#x27;;</code> | [lib/src/features/feedback/view_states/klp_progress_overlay.dart:1](../../../../../../lib/src/features/feedback/view_states/klp_progress_overlay.dart#L1) |
...
ClassDeclaration · public · [lib/src/features/feedback/view_states/klp_progress_overlay.dart:3](../../../../../../lib/src/features/feedback/view_states/klp_progress_overlay.dart#L3)

<code>class KlpProgressOverlay extends StatelessWidget</code>

- `extends` → <code>StatelessWidget</code>：[lib/src/features/feedback/view_states/klp_progress_overlay.dart:3](../../../../../../lib/src/features/feedback/view_states/klp_progress_overlay.dart#L3)
