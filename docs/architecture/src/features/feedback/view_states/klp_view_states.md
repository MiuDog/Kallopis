...
[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/features/feedback/view_states/klp_view_states.dart)

## 範圍

核心是 `lib/src/features/feedback/view_states/klp_view_states.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
flowchart LR
	n0["klp_view_states.dart"]
	n1["klp_loading_state.dart"]
	n2["klp_permission_state.dart"]
	n3["klp_progress_overlay.dart"]
	n4["klp_view_state.dart"]
	n0 -->|"part"| n1
	n0 -->|"part"| n2
	n0 -->|"part"| n3
	n0 -->|"part"| n4
...
| part | <code>part &#x27;klp_progress_overlay.dart&#x27;;</code> | [lib/src/features/feedback/view_states/klp_view_states.dart:16](../../../../../../lib/src/features/feedback/view_states/klp_view_states.dart#L16) |
| part | <code>part &#x27;klp_view_state.dart&#x27;;</code> | [lib/src/features/feedback/view_states/klp_view_states.dart:17](../../../../../../lib/src/features/feedback/view_states/klp_view_states.dart#L17) |
