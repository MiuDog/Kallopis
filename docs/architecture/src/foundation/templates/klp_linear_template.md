# klp_linear_template.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../lib/src/foundation/templates/klp_linear_template.dart)

## 範圍

核心是 `lib/src/foundation/templates/klp_linear_template.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_linear_template.dart"]
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| part of | <code>part of &#x27;klp_template.dart&#x27;;</code> | [lib/src/foundation/templates/klp_linear_template.dart:1](../../../../../lib/src/foundation/templates/klp_linear_template.dart#L1) |
...
ClassDeclaration · public · [lib/src/foundation/templates/klp_linear_template.dart:3](../../../../../lib/src/foundation/templates/klp_linear_template.dart#L3)

<code>final class KlpLinearTemplate&lt;T extends KlpNode&gt; extends KlpTemplate&lt;T&gt;</code>

來源註解摘要：線性組合只接受相同資料契約的受控模板，並保存子項快照。

- `extends` → <code>KlpTemplate&lt;T&gt;</code>：[lib/src/foundation/templates/klp_linear_template.dart:4](../../../../../lib/src/foundation/templates/klp_linear_template.dart#L4)
