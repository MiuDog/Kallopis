# lib/src/foundation/interaction/filter/primitives：架構分析入口

[上一層](../README.md)

## 範圍

閱讀 `lib/src/foundation/interaction/filter/primitives` 的直接子目錄與 Dart 檔案。結構圖表示實際檔案包含關係；依賴圖表示本層檔案明寫的 directives。每個檔案頁另列直接依賴、宣告、欄位、方法、建構子及行號證據。
...
```mermaid
flowchart TD
	n0["lib/src/foundation/interaction/filter/primitives"]
...
flowchart LR
	n0["lib/src/foundation/interaction/filter/primitives"]
	n1["klp_filter_chip_frame.dart"]
	n2["klp_filter_chip_style.dart"]
...
| 檔案 | 宣告 | 細節 | 來源證據 |
|---|---|---|---|
| `klp_filter_chip_frame.dart` | _KlpFilterChipFrame | [架構與 API](klp_filter_chip_frame.md) | [lib/src/foundation/interaction/filter/primitives/klp_filter_chip_frame.dart:1](../../../../../../../lib/src/foundation/interaction/filter/primitives/klp_filter_chip_frame.dart#L1) |
| `klp_filter_chip_style.dart` | _KlpFilterChipStyle | [架構與 API](klp_filter_chip_style.md) | [lib/src/foundation/interaction/filter/primitives/klp_filter_chip_style.dart:1](../../../../../../../lib/src/foundation/interaction/filter/primitives/klp_filter_chip_style.dart#L1) |
