...
flowchart LR
	...
	n1["dart:math"]
	n2["lib/src/styling/legacy_metrics"]
...
| <code>lib/src/styling/legacy_metrics</code> | export | 1 | [lib/src/foundation/klp_metrics.dart:1](../../../../lib/src/foundation/klp_metrics.dart#L1) |
...
| <code>klp_icon.dart → klp_icon_fonts.dart</code> | import | [lib/src/foundation/klp_icon.dart:5](../../../../lib/src/foundation/klp_icon.dart#L5) |
| <code>klp_icon.dart → klp_icon_weight.dart</code> | import | [lib/src/foundation/klp_icon.dart:6](../../../../lib/src/foundation/klp_icon.dart#L6) |
| <code>klp_icon.dart → klp_icon_data.dart</code> | export | [lib/src/foundation/klp_icon.dart:8](../../../../lib/src/foundation/klp_icon.dart#L8) |
| <code>klp_icon.dart → klp_icon_weight.dart</code> | export | [lib/src/foundation/klp_icon.dart:9](../../../../lib/src/foundation/klp_icon.dart#L9) |
...
flowchart LR
	...
	n8["surface/"]
	n9["templates/"]
	n10["klp_geometric_spinner.dart"]
	n11["klp_geometric_spinner_painter.dart"]
	n0 -->|"contains"| n1
	n0 -->|"contains"| n2
	n0 -->|"contains"| n3
	n0 -->|"contains"| n4
...
flowchart LR
	n0["lib/src/foundation"]
	n1["klp_geometric_spinner_state.dart"]
	n2["klp_icon.dart"]
...
| `localization/` | [架構入口](localization/README.md) | [來源目錄](../../../../lib/src/foundation/localization) |
...
| `klp_icon_fonts.dart` | KlpIconFonts | [架構與 API](klp_icon_fonts.md) | [lib/src/foundation/klp_icon_fonts.dart:1](../../../../lib/src/foundation/klp_icon_fonts.dart#L1) |
