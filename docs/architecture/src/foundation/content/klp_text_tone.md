# klp_text_tone.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../lib/src/foundation/content/klp_text_tone.dart)

## 範圍

核心是 `lib/src/foundation/content/klp_text_tone.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。

## 直接依賴圖

```mermaid
flowchart TD
	n0["klp_text_tone.dart"]
```
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| 無 | 本檔未宣告 import／export／part | [lib/src/foundation/content/klp_text_tone.dart:1](../../../../../lib/src/foundation/content/klp_text_tone.dart#L1) |
...
EnumDeclaration · public · [lib/src/foundation/content/klp_text_tone.dart:1](../../../../../lib/src/foundation/content/klp_text_tone.dart#L1)
