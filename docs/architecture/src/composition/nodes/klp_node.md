# klp_node.dart：直接依賴與宣告架構

[回到目錄](README.md) · [來源檔案](../../../../../lib/src/composition/nodes/klp_node.dart)

## 範圍

核心是 `lib/src/composition/nodes/klp_node.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
來源註解摘要：受控結構節點；只描述資料及子項，不取得渲染上下文。
