...
flowchart TD
	...
	n1["lib/src/composition/slots"]
	n0 -->|"import"| n1
```

| 目標邊界 | 關係 | directive 數 | 第一筆來源證據 |
|---|---|---|---|
| <code>lib/src/composition/slots</code> | import | 1 | [lib/src/composition/nodes/klp_composite_node.dart:1](../../../../../lib/src/composition/nodes/klp_composite_node.dart#L1) |
