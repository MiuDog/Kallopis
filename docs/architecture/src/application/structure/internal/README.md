# lib/src/application/structure/internal：架構分析入口

[上一層](../README.md)

## 範圍

閱讀 `lib/src/application/structure/internal` 的直接子目錄與 Dart 檔案。結構圖表示實際檔案包含關係；依賴圖表示本層檔案明寫的 directives。每個檔案頁另列直接依賴、宣告、欄位、方法、建構子及行號證據。
...
```mermaid
flowchart LR
	n0["lib/src/application/structure/internal"]
...
| 檔案 | 宣告 | 細節 | 來源證據 |
|---|---|---|---|
| `klp_retained_screens.dart` | KlpRetainedScreens | [架構與 API](klp_retained_screens.md) | [lib/src/application/structure/internal/klp_retained_screens.dart:1](../../../../../../lib/src/application/structure/internal/klp_retained_screens.dart#L1) |
