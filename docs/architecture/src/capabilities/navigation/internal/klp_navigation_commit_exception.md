...
[回到目錄](README.md) · [來源檔案](../../../../../../lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart)

## 範圍

核心是 `lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart`。主要視角為該檔案明寫的 import／export／part；輔助視角為本檔宣告及 extends／implements／with／on 關係。只展開一層外部邊界。
...
| 關係 | 原始 directive | 來源 |
|---|---|---|
| 無 | 本檔未宣告 import／export／part | [lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart:1](../../../../../../lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart#L1) |
...
ClassDeclaration · public · [lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart:1](../../../../../../lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart#L1)

<code>final class KlpNavigationCommitException implements Exception</code>

來源註解摘要：轉接層必須明示例外發生在提交前或提交後。

- `implements` → <code>Exception</code>：[lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart:2](../../../../../../lib/src/capabilities/navigation/internal/klp_navigation_commit_exception.dart#L2)
