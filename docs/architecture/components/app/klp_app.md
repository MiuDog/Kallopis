...
- [`KlpAppScope`](./klp_app_scope.md) — `app — 應用程式進入點與根容器`
- [`KlpEnvironmentScope`](./klp_environment_scope.md) — `app — 應用程式進入點與根容器`
- [`KlpKeyBindingHost`](../interaction/klp_key_binding_host.md) — `interaction — 互動`
...
- 檔案路徑：[`lib/src/app/klp_app.dart`](../../../../lib/src/app/klp_app.dart#L85)
- 宣告型態：`StatefulWidget`
