# KlpBlockCanvas：元件樹架構

## 範圍

- **核心元件**：`KlpBlockCanvas`
- **所屬領域**：`surface — 表面與描邊`
- **核心職責**：Kallopis KlpBlockCanvas 元件
...
- [`KlpSurface`](./klp_surface.md) — `surface — 表面與描邊` *(純容器，已繼續向下展開)*

## 程式碼證據

- 檔案路徑：[`lib/src/surface/klp_block.dart`](../../../../lib/src/surface/klp_block.dart#L30)
