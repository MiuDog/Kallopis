# KlpPageBackgroundPainter：元件樹架構

## 範圍

- **核心元件**：`KlpPageBackgroundPainter`
- **所屬領域**：`surface — 表面與描邊`
- **核心職責**：所有頁面背景 recipe 共用的 renderer。
...
flowchart TD
  ...
  root["KlpPageBackgroundPainter"]:::root
...
- 檔案路徑：[`lib/src/surface/page_background/klp_page_background_painter.dart`](../../../../lib/src/surface/page_background/klp_page_background_painter.dart#L40)
