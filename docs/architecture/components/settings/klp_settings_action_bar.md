...
- **所屬領域**：`settings`
- **核心職責**：固定於設定內容捲動區外的狀態與動作列。  此元件只負責呈現；dirty／saving／failure 等狀態機由消費者決定。
...
- 檔案路徑：[`lib/src/settings/klp_settings_content.dart`](../../../../lib/src/settings/klp_settings_content.dart#L48)
