...
flowchart TD
  ...
  n2["Wrap"]
  root --> n2
  n3["KlpThemePreviewTile"]:::reference
  root --> n3
  n4["child / slot"]:::slot
  root --> n4
```
...
- [`KlpThemePreviewTile`](../shell/klp_theme_preview_tile.md) — `shell — 應用外殼`

## 程式碼證據

- 檔案路徑：[`lib/src/settings/klp_theme_mode_picker.dart`](../../../../lib/src/settings/klp_theme_mode_picker.dart#L25)
