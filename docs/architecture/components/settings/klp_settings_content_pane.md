...
flowchart TD
  ...
  n4["Expanded"]
  n3 --> n4
  n5["SingleChildScrollView"]
  n4 --> n5
  n6["Center"]
  n5 --> n6
  n7["ConstrainedBox"]
  n6 --> n7
  n8["KlpSettingsContentHeader"]:::reference
  n7 --> n8
  n9["SizedBox"]
  n7 --> n9
...
- [`KlpSettingsContentHeader`](./klp_settings_content_header.md) — `settings`
- [`KlpSurface`](../surface/klp_surface.md) — `surface — 表面與描邊` *(純容器，已繼續向下展開)*

## 程式碼證據

- 檔案路徑：[`lib/src/settings/klp_settings_layout.dart`](../../../../lib/src/settings/klp_settings_layout.dart#L186)
