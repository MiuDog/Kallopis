# KlpWorkflowStateSurface：元件樹架構

## 範圍

- **核心元件**：`KlpWorkflowStateSurface`
- **所屬領域**：`features`
- **核心職責**：將有限工作流狀態轉成可讀、可宣告的狀態表面。
...
flowchart TD
  ...
  root["KlpWorkflowStateSurface"]:::root
  ...
  n5["KlpRow"]:::reference
  n2 --> n5
  n6["KlpGeometricSpinner"]:::reference
  n2 --> n6
  n7["KlpExpanded"]:::reference
  n2 --> n7
  n8["KlpText"]:::reference
  n2 --> n8
  n9["KlpBadge"]:::reference
  n2 --> n9
  n10["KlpAlign"]:::reference
  n2 --> n10
...
- 檔案路徑：[`lib/src/features/feedback/workflow/klp_workflow_state_surface.dart`](../../../../lib/src/features/feedback/workflow/klp_workflow_state_surface.dart#L4)
