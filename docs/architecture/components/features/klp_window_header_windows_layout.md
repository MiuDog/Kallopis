# KlpWindowHeaderWindowsLayout：元件樹架構

## 範圍

- **核心元件**：`KlpWindowHeaderWindowsLayout`
- **所屬領域**：`features`
- **核心職責**：Windows 平台的視窗標題列排版元件。
...
flowchart TD
  ...
  root["KlpWindowHeaderWindowsLayout"]:::root
  n1["KlpRow"]:::reference
  root --> n1
  n2["KlpBox"]:::reference
  root --> n2
...
- 檔案路徑：[`lib/src/features/workspace/shell/window/klp_window_header_windows_layout.dart`](../../../../lib/src/features/workspace/shell/window/klp_window_header_windows_layout.dart#L16)
