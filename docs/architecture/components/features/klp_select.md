...
- [`KlpStrokeFrame`](../foundation/klp_stroke_frame.md) — `foundation — 圖示、色盤、度量` *(純容器，已繼續向下展開)*
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/forms/selection/internal/klp_select_widget.dart`](../../../../lib/src/features/forms/selection/internal/klp_select_widget.dart#L4)
- 宣告型態：`StatefulWidget`
