# KlpThemeModePicker：元件樹架構

## 範圍

- **核心元件**：`KlpThemeModePicker`
- **所屬領域**：`features`
- **核心職責**：以 Kallopis 預覽磚排列受控的顏色模式選項。
...
flowchart TD
  ...
  root["KlpThemeModePicker"]:::root
  n1["KlpWrap"]:::reference
  root --> n1
  n2["KlpThemePreviewTile"]:::reference
  root --> n2
```

## 外部元件引用

- [`KlpThemePreviewTile`](./klp_theme_preview_tile.md) — `features`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/settings/klp_theme_mode_picker.dart`](../../../../lib/src/features/workspace/settings/klp_theme_mode_picker.dart#L11)
