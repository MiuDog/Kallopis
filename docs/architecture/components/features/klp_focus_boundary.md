# KlpFocusBoundary：元件樹架構

## 範圍

- **核心元件**：`KlpFocusBoundary`
- **所屬領域**：`features`
- **核心職責**：建立可回復焦點的邊界；對話框或導覽完成後可呼叫 [requestFocus]。
...
- 檔案路徑：[`lib/src/features/feedback/workflow/klp_focus_boundary.dart`](../../../../lib/src/features/feedback/workflow/klp_focus_boundary.dart#L4)
- 宣告型態：`StatefulWidget`
