# KlpThemePreviewTile：元件樹架構

## 範圍

- **核心元件**：`KlpThemePreviewTile`
- **所屬領域**：`features`
- **核心職責**：以插圖預覽受控的 Kallopis 顏色模式。
...
- 檔案路徑：[`lib/src/features/workspace/shell/theme/klp_theme_preview_tile.dart`](../../../../lib/src/features/workspace/shell/theme/klp_theme_preview_tile.dart#L22)
