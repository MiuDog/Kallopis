...
- **核心元件**：`KlpMetricCard`
- **所屬領域**：`features`
- **核心職責**：指標呈現卡片 (Metric Card)。  呈現標籤、核心數值、單位、趨勢箭頭、狀態說明或迷你進度長條。 支援正常（neutral/success）與違規告警（danger 具備紅色外框與文字）。
...
- 檔案路徑：[`lib/src/features/collections/card/internal/klp_metric_card_widget.dart`](../../../../lib/src/features/collections/card/internal/klp_metric_card_widget.dart#L7)
