# KlpDocumentSection：元件樹架構

## 範圍

- **核心元件**：`KlpDocumentSection`
- **所屬領域**：`features`
- **核心職責**：文件的單一語意章節；可選的動作不改變章節資料所有權。
...
- 檔案路徑：[`lib/src/features/workspace/artifact/internal/klp_document_section.dart`](../../../../lib/src/features/workspace/artifact/internal/klp_document_section.dart#L4)
