# KlpSidebarNavigationGroup：元件樹架構

## 範圍

- **核心元件**：`KlpSidebarNavigationGroup`
- **所屬領域**：`features`
- **核心職責**：Primary Sidebar 的全寬導覽列群組。  呼叫端只決定項目順序；相鄰列緊密排列，不插入額外間距或分隔線。
...
flowchart TD
  ...
  root["KlpSidebarNavigationGroup"]:::root
  n1["Column"]
  root --> n1
```
...
- 檔案路徑：[`lib/src/features/navigation/widgets/sidebar/klp_sidebar_navigation_group.dart`](../../../../lib/src/features/navigation/widgets/sidebar/klp_sidebar_navigation_group.dart#L6)
