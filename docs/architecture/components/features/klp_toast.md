...
- **核心元件**：`KlpToast`
- **所屬領域**：`features`
- **核心職責**：短暫通知。**不負責排程與消失**——停留時間取自 `theme.motion.toastDwell`， 但實際的顯示與收起由呼叫端控制。
...
flowchart TD
  ...
  root["KlpToast"]:::root
  n1["KlpConstrainedBox"]:::reference
  root --> n1
  ...
  n2 --> n9
  n10["KlpWrap"]:::reference
  n2 --> n10
  n11["KlpButton"]:::reference
  n2 --> n11
  n12["child / slot"]:::slot
  n2 --> n12
```
...
- 檔案路徑：[`lib/src/features/feedback/toast/klp_toast_widget.dart`](../../../../lib/src/features/feedback/toast/klp_toast_widget.dart#L5)
