# KlpTriStateToggle：元件樹架構

## 範圍

- **核心元件**：`KlpTriStateToggle`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpTriStateToggle 元件
...
flowchart TD
  ...
  root["KlpTriStateToggle"]:::root
  n1["KlpRow"]:::reference
  root --> n1
  n2["KlpSlidingSelection"]:::reference
  root --> n2
...
- [`KlpSlidingSelection`](./klp_sliding_selection.md) — `features`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/forms/toggle/internal/klp_tri_state_toggle_widget.dart`](../../../../lib/src/features/forms/toggle/internal/klp_tri_state_toggle_widget.dart#L3)
