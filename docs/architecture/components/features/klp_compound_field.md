# KlpCompoundField：元件樹架構

## 範圍

- **核心元件**：`KlpCompoundField`
- **所屬領域**：`features`
- **核心職責**：在單一控制框內組合主要文字與受控尾端選項。
...
- 檔案路徑：[`lib/src/features/forms/input/internal/klp_compound_field_widget.dart`](../../../../lib/src/features/forms/input/internal/klp_compound_field_widget.dart#L4)
- 宣告型態：`StatefulWidget`
