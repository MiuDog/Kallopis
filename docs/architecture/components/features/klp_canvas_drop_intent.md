# KlpCanvasDropIntent：元件樹架構

## 範圍

- **核心元件**：`KlpCanvasDropIntent`
- **所屬領域**：`features`
- **核心職責**：插入、重排、包覆、重設父層或疊放等 drop intent 指示器。
...
- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_canvas_drop_intent.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_canvas_drop_intent.dart#L4)
