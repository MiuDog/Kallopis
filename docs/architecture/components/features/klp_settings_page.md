# KlpSettingsPage：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsPage`
- **所屬領域**：`features`
- **核心職責**：設定頁的自適應雙 pane 版面。  只安排 navigation 與 content；route、Popup 與設定狀態由產品層負責。
...
flowchart TD
  ...
  n3["KlpBox"]:::reference
  root --> n3
  n4["KlpResizeHandle"]:::reference
  root --> n4
  n5["KlpExpanded"]:::reference
  root --> n5
  n6["KlpColumn"]:::reference
  root --> n6
  n7["KlpFlexible"]:::reference
  root --> n7
  n8["child / slot"]:::slot
  root --> n8
```
...
- [`KlpResizeHandle`](../foundation/klp_resize_handle.md) — `foundation — 圖示、色盤、度量`
- [`KlpRow`](../foundation/klp_row.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/settings/layout/klp_settings_page.dart`](../../../../lib/src/features/workspace/settings/layout/klp_settings_page.dart#L6)
