# KlpSettingsNavigationHeader：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsNavigationHeader`
- **所屬領域**：`features`
- **核心職責**：Settings 左欄固定區域，組合 identity 與搜尋。
...
flowchart TD
  ...
  root["KlpSettingsNavigationHeader"]:::root
  n1["KlpBox"]:::reference
  root --> n1
  n2["KlpRow"]:::reference
  root --> n2
...
- [`KlpPressable`](../foundation/klp_pressable.md) — `foundation — 圖示、色盤、度量`
- [`KlpRow`](../foundation/klp_row.md) — `foundation — 圖示、色盤、度量`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/settings/navigation/klp_settings_navigation_header.dart`](../../../../lib/src/features/workspace/settings/navigation/klp_settings_navigation_header.dart#L4)
