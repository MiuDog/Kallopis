...
flowchart TD
  ...
  root["KlpButton"]:::root
  n1["leading (slot)"]:::slot
  root --> n1
  n2["trailing (slot)"]:::slot
  root --> n2
  n3["child / slot"]:::slot
  root --> n3
```
...
- 檔案路徑：[`lib/src/features/actions/button/internal/klp_button_widget.dart`](../../../../lib/src/features/actions/button/internal/klp_button_widget.dart#L7)
- 宣告型態：`StatefulWidget`
