# KlpQuantityField：元件樹架構

## 範圍

- **核心元件**：`KlpQuantityField`
- **所屬領域**：`features`
- **核心職責**：以欄位等高的減少／增加操作調整數量。
...
flowchart TD
  ...
  root["KlpQuantityField"]:::root
  n1["KlpRow"]:::reference
  root --> n1
  n2["KlpExpanded"]:::reference
  root --> n2
  n3["KlpCenter"]:::reference
  root --> n3
...
- 檔案路徑：[`lib/src/features/forms/input/klp_quantity_field.dart`](../../../../lib/src/features/forms/input/klp_quantity_field.dart#L8)
