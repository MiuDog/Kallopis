# KlpSlidingSelection：元件樹架構

## 範圍

- **核心元件**：`KlpSlidingSelection`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpSlidingSelection 元件
...
- 檔案路徑：[`lib/src/features/forms/selection/internal/klp_sliding_selection_widget.dart`](../../../../lib/src/features/forms/selection/internal/klp_sliding_selection_widget.dart#L3)
