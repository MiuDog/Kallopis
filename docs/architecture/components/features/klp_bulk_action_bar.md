# KlpBulkActionBar：元件樹架構

## 範圍

- **核心元件**：`KlpBulkActionBar`
- **所屬領域**：`features`
- **核心職責**：以摘要標籤與可換行動作呈現批次操作列。
...
- 檔案路徑：[`lib/src/features/actions/editor/klp_bulk_action_bar.dart`](../../../../lib/src/features/actions/editor/klp_bulk_action_bar.dart#L4)
