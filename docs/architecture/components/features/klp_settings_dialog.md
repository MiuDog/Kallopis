# KlpSettingsDialog：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsDialog`
- **所屬領域**：`features`
- **核心職責**：Settings modal 的桌面框架；尺寸、置中與透明 Dialog chrome 全由 Kallopis 管理。
...
flowchart TD
  ...
  root["KlpSettingsDialog"]:::root
  n1["KlpModalFrame"]:::reference
  root --> n1
  n2["KlpBox"]:::reference
  root --> n2
  n3["child / slot"]:::slot
...
- [`KlpModalFrame`](./klp_modal_frame.md) — `features`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/settings/layout/klp_settings_dialog.dart`](../../../../lib/src/features/workspace/settings/layout/klp_settings_dialog.dart#L4)
