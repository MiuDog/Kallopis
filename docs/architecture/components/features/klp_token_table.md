...
- **核心元件**：`KlpTokenTable`
- **所屬領域**：`features`
- **核心職責**：可排序 Token 清單的表格呈現；排序狀態由呼叫端持有。
...
flowchart TD
  ...
  root["KlpTokenTable"]:::root
  n1["KlpDataTable"]:::reference
  root --> n1
...
- [`KlpDataTable`](./klp_data_table.md) — `features`
...
- 檔案路徑：[`lib/src/features/workspace/artifact/internal/klp_token_table.dart`](../../../../lib/src/features/workspace/artifact/internal/klp_token_table.dart#L4)
