...
- **核心元件**：`KlpToastStack`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpToastStack 元件
...
- 檔案路徑：[`lib/src/features/feedback/toast/klp_toast_stack.dart`](../../../../lib/src/features/feedback/toast/klp_toast_stack.dart#L3)
