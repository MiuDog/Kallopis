# KlpDateRangeField：元件樹架構

## 範圍

- **核心元件**：`KlpDateRangeField`
- **所屬領域**：`features`
- **核心職責**：在同一控制框中編輯起訖日期，並可由尾端動作開啟產品提供的日期挑選器。
...
- 檔案路徑：[`lib/src/features/forms/selection/klp_date_range_field.dart`](../../../../lib/src/features/forms/selection/klp_date_range_field.dart#L8)
