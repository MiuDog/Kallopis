...
- **核心元件**：`KlpTooltip`
- **所屬領域**：`features`
- **核心職責**：將 Flutter tooltip 行為封裝在 overlay primitive 邊界內。
...
- 檔案路徑：[`lib/src/features/overlays/primitives/klp_tooltip_widget.dart`](../../../../lib/src/features/overlays/primitives/klp_tooltip_widget.dart#L4)
