# KlpFlowValidationPanel：元件樹架構

## 範圍

- **核心元件**：`KlpFlowValidationPanel`
- **所屬領域**：`features`
- **核心職責**：Flow 風險或驗證訊息清單；風險計算與修復動作由領域層提供。
...
flowchart TD
  ...
  root["KlpFlowValidationPanel"]:::root
  n1["KlpColumn"]:::reference
  root --> n1
  n2["KlpText"]:::reference
  root --> n2
  n3["KlpInlineNotice"]:::reference
  root --> n3
  n4["KlpWrap"]:::reference
  root --> n4
```
...
- [`KlpInlineNotice`](./klp_inline_notice.md) — `features`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_flow_validation_panel.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_flow_validation_panel.dart#L4)
