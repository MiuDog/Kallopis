# KlpSegmentedControl：元件樹架構

## 範圍

- **核心元件**：`KlpSegmentedControl`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpSegmentedControl 元件
...
- 檔案路徑：[`lib/src/features/forms/selection/internal/klp_segmented_control_widget.dart`](../../../../lib/src/features/forms/selection/internal/klp_segmented_control_widget.dart#L3)
