# KlpPaneCollapseControl：元件樹架構

## 範圍

- **核心元件**：`KlpPaneCollapseControl`
- **所屬領域**：`features`
- **核心職責**：Pane 的收合互動控制。
...
- 檔案路徑：[`lib/src/features/workspace/shell/composition/pane/klp_pane_collapse_control.dart`](../../../../lib/src/features/workspace/shell/composition/pane/klp_pane_collapse_control.dart#L13)
