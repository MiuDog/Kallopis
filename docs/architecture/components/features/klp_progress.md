...
flowchart TD
  ...
  root --> n4
  n5["KlpSpacer"]:::reference
  root --> n5
  n6["KlpGestureRegion"]:::reference
  root --> n6
...
- 檔案路徑：[`lib/src/features/collections/progress/internal/klp_progress_widget.dart`](../../../../lib/src/features/collections/progress/internal/klp_progress_widget.dart#L4)
