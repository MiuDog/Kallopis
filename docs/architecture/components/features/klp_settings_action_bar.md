# KlpSettingsActionBar：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsActionBar`
- **所屬領域**：`features`
- **核心職責**：固定於設定內容捲動區外的狀態與動作列。
...
flowchart TD
  ...
  root["KlpSettingsActionBar"]:::root
  n1["KlpBox"]:::reference
  root --> n1
...
- 檔案路徑：[`lib/src/features/workspace/settings/klp_settings_action_bar.dart`](../../../../lib/src/features/workspace/settings/klp_settings_action_bar.dart#L15)
