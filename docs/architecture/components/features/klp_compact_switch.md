# KlpCompactSwitch：元件樹架構

## 範圍

- **核心元件**：`KlpCompactSwitch`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpCompactSwitch 元件
...
- 檔案路徑：[`lib/src/features/forms/toggle/internal/klp_compact_switch_widget.dart`](../../../../lib/src/features/forms/toggle/internal/klp_compact_switch_widget.dart#L3)
