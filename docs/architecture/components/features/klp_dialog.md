...
- **核心元件**：`KlpDialog`
- **所屬領域**：`features`
- **核心職責**：對話框內容。**不負責彈出**——呼叫端自行決定用 `showDialog` 或其他方式呈現。 `secondaryLabel` 為必填：庫不替產品決定用什麼語言說「取消」。
...
- 檔案路徑：[`lib/src/features/overlays/klp_dialog.dart`](../../../../lib/src/features/overlays/klp_dialog.dart#L11)
