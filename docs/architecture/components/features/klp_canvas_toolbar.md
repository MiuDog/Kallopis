# KlpCanvasToolbar：元件樹架構

## 範圍

- **核心元件**：`KlpCanvasToolbar`
- **所屬領域**：`features`
- **核心職責**：畫布上的有限動作工具列；動作能力由呼叫端決定。
...
flowchart TD
  ...
  root["KlpCanvasToolbar"]:::root
  n1["KlpBox"]:::reference
  root --> n1
  n2["KlpWrap"]:::reference
  root --> n2
  n3["child / slot"]:::slot
  root --> n3
```
...
- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_canvas_toolbar.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_canvas_toolbar.dart#L4)
