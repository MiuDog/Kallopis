# KlpCanvasMinimap：元件樹架構

## 範圍

- **核心元件**：`KlpCanvasMinimap`
- **所屬領域**：`features`
- **核心職責**：大型空間文件的小地圖容器；viewport 投影由呼叫端提供。
...
- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_canvas_minimap.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_canvas_minimap.dart#L4)
