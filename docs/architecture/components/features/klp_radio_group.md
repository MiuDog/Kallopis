...
- **核心元件**：`KlpRadioGroup`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpRadioGroup 元件
...
- 檔案路徑：[`lib/src/features/forms/selection/internal/klp_radio_group_widget.dart`](../../../../lib/src/features/forms/selection/internal/klp_radio_group_widget.dart#L3)
