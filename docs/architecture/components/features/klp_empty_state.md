...
- **核心元件**：`KlpEmptyState`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpEmptyState 元件
...
- 檔案路徑：[`lib/src/features/feedback/empty_state/klp_empty_state_widget.dart`](../../../../lib/src/features/feedback/empty_state/klp_empty_state_widget.dart#L3)
