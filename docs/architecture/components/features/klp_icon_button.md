...
- [`KlpTooltip`](./klp_tooltip.md) — `features`

## 程式碼證據

- 檔案路徑：[`lib/src/features/actions/button/internal/klp_icon_button_widget.dart`](../../../../lib/src/features/actions/button/internal/klp_icon_button_widget.dart#L4)
- 宣告型態：`StatefulWidget`
