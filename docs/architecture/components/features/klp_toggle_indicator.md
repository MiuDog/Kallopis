# KlpToggleIndicator：元件樹架構

## 範圍

- **核心元件**：`KlpToggleIndicator`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpToggleIndicator 元件
...
- 檔案路徑：[`lib/src/features/forms/toggle/internal/klp_toggle_indicator_widget.dart`](../../../../lib/src/features/forms/toggle/internal/klp_toggle_indicator_widget.dart#L3)
