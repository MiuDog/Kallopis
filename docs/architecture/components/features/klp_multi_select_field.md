# KlpMultiSelectField：元件樹架構

## 範圍

- **核心元件**：`KlpMultiSelectField`
- **所屬領域**：`features`
- **核心職責**：多選欄位：所有選項以可切換的標籤形式平鋪展示。  [selectedIds] 由呼叫端持有；點擊選項只透過 [onChanged] 回報下一個集合。
...
- 檔案路徑：[`lib/src/features/forms/selection/klp_multi_select_field.dart`](../../../../lib/src/features/forms/selection/klp_multi_select_field.dart#L10)
