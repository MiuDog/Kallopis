...
- **核心元件**：`KlpTextField`
- **所屬領域**：`features`
- **核心職責**：單行或多行文字輸入。底層輸入能力由 Kallopis primitive 提供，消費者不需要 額外準備 `Material` 祖先。
...
- 檔案路徑：[`lib/src/features/forms/input/internal/klp_text_field_widget.dart`](../../../../lib/src/features/forms/input/internal/klp_text_field_widget.dart#L5)
- 宣告型態：`StatefulWidget`
