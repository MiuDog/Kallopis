# KlpMessageComposer：元件樹架構

## 範圍

- **核心元件**：`KlpMessageComposer`
- **所屬領域**：`features`
- **核心職責**：帶有範圍標籤、附件動作與提交動作的多行訊息輸入器。
...
flowchart TD
  ...
  root["KlpMessageComposer"]:::root
  n1["KlpTextArea"]:::reference
  root --> n1
  n2["KlpSurface"]:::container
  root --> n2
  n3["KlpBox"]:::reference
  n2 --> n3
  n4["KlpLayoutBuilder"]:::reference
  n2 --> n4
  n5["KlpColumn"]:::reference
  n2 --> n5
  n6["KlpWrap"]:::reference
  n2 --> n6
  n7["KlpBadge"]:::reference
  n2 --> n7
...
- [`KlpTextArea`](./klp_text_area.md) — `features`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/message_composer/internal/klp_message_composer_widget.dart`](../../../../lib/src/features/workspace/message_composer/internal/klp_message_composer_widget.dart#L4)
