# KlpWindowControls：元件樹架構

## 範圍

- **核心元件**：`KlpWindowControls`
- **所屬領域**：`features`
- **核心職責**：依平台策略排列視窗控制按鈕。
...
flowchart TD
  ...
  root["KlpWindowControls"]:::root
  n1["KlpAdaptive"]:::reference
  root --> n1
```
...
- 檔案路徑：[`lib/src/features/workspace/shell/window/klp_window_controls.dart`](../../../../lib/src/features/workspace/shell/window/klp_window_controls.dart#L13)
