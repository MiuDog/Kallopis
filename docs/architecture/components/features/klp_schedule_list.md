# KlpScheduleList：元件樹架構

## 範圍

- **核心元件**：`KlpScheduleList`
- **所屬領域**：`features`
- **核心職責**：固定時間欄、標題與選填標籤的排程清單。
...
- 檔案路徑：[`lib/src/features/collections/agenda/klp_schedule_list.dart`](../../../../lib/src/features/collections/agenda/klp_schedule_list.dart#L14)
