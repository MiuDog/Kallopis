# KlpOklchColorEditor：元件樹架構

## 範圍

- **核心元件**：`KlpOklchColorEditor`
- **所屬領域**：`features`
- **核心職責**：以 Lightness、Chroma、Hue 與 Alpha 編輯 [KlpOklchColor] 的控制項。
...
flowchart TD
  ...
  root["KlpOklchColorEditor"]:::root
  n1["KlpLayoutBuilder"]:::reference
  root --> n1
  n2["KlpColumn"]:::reference
  root --> n2
  n3["KlpWrap"]:::reference
  root --> n3
  n4["KlpSemanticRegion"]:::reference
  root --> n4
  n5["KlpSlider"]:::reference
  root --> n5
  n6["child / slot"]:::slot
  root --> n6
```
...
- [`KlpSlider`](./klp_slider.md) — `features`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/forms/color/internal/klp_oklch_color_editor_widget.dart`](../../../../lib/src/features/forms/color/internal/klp_oklch_color_editor_widget.dart#L4)
