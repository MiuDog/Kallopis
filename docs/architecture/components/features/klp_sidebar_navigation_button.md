# KlpSidebarNavigationButton：元件樹架構

## 範圍

- **核心元件**：`KlpSidebarNavigationButton`
- **所屬領域**：`features`
- **核心職責**：Primary Sidebar 內的全寬導覽按鈕。  消費者只提供圖示、標籤、選取狀態與事件；高度、內距、圓角、圖示尺寸、 hover 與選取色全部由 Kallopis theme 決定。
...
flowchart TD
  ...
  root["KlpSidebarNavigationButton"]:::root
...
- 檔案路徑：[`lib/src/features/navigation/widgets/sidebar/klp_sidebar_navigation_button.dart`](../../../../lib/src/features/navigation/widgets/sidebar/klp_sidebar_navigation_button.dart#L20)
- 宣告型態：`StatefulWidget`
