# KlpSettingsContentHeader：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsContentHeader`
- **所屬領域**：`features`
- **核心職責**：Settings 右欄的固定標題組合，可單獨用於自訂內容 pane。
...
flowchart TD
  ...
  root["KlpSettingsContentHeader"]:::root
...
- 檔案路徑：[`lib/src/features/workspace/settings/layout/klp_settings_content_header.dart`](../../../../lib/src/features/workspace/settings/layout/klp_settings_content_header.dart#L4)
