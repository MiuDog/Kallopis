# KlpSettingsNavigationGroup：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsNavigationGroup`
- **所屬領域**：`features`
- **核心職責**：設定導覽中不可收縮的分類標題與 section 集合。
...
flowchart TD
  ...
  root["KlpSettingsNavigationGroup"]:::root
...
- 檔案路徑：[`lib/src/features/workspace/settings/navigation/klp_settings_navigation_group.dart`](../../../../lib/src/features/workspace/settings/navigation/klp_settings_navigation_group.dart#L4)
