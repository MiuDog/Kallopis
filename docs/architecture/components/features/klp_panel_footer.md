# KlpPanelFooter：元件樹架構

## 範圍

- **核心元件**：`KlpPanelFooter`
- **所屬領域**：`features`
- **核心職責**：Panel 底部區域的共用配方。  不繪製背景、邊框或圓角，完全繼承父 [KlpPanelFrame] 的 surface 與裁切； 只統一 footer 內容的水平 inset。
...
- 檔案路徑：[`lib/src/features/workspace/shell/panel/klp_panel_footer.dart`](../../../../lib/src/features/workspace/shell/panel/klp_panel_footer.dart#L9)
