...
- **核心元件**：`KlpWorkbenchNavigationRegion`
- **所屬領域**：`features`
- **核心職責**：Workbench 左側導覽區域：並排獨立的 Rail 與 Sidebar surface。  本層只決定兩個同層區域的寬度與間距；完整的 Panel Tree 由 Dock layout 擁有。
...
flowchart TD
  ...
  root["KlpWorkbenchNavigationRegion"]:::root
  n1["Row"]
  root --> n1
  n2["SizedBox"]
  n1 --> n2
...
- 檔案路徑：[`lib/src/features/workspace/shell/sidebar/klp_workbench_navigation_region.dart`](../../../../lib/src/features/workspace/shell/sidebar/klp_workbench_navigation_region.dart#L9)
