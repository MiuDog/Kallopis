# KlpTagInputField：元件樹架構

## 範圍

- **核心元件**：`KlpTagInputField`
- **所屬領域**：`features`
- **核心職責**：標籤輸入與群組欄位。支援新增、移除個別標籤與清空所有標籤。
...
- [`KlpTagChip`](./klp_tag_chip.md) — `features`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/forms/selection/klp_tag_input_field.dart`](../../../../lib/src/features/forms/selection/klp_tag_input_field.dart#L7)
