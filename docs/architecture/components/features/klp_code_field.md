...
flowchart TD
  ...
  root --> n3
  n4["KlpCodeViewer"]:::reference
  root --> n4
```

## 外部元件引用

- [`KlpCodeViewer`](./klp_code_viewer.md) — `features`
...
- 檔案路徑：[`lib/src/features/forms/structured/internal/klp_code_field_widget.dart`](../../../../lib/src/features/forms/structured/internal/klp_code_field_widget.dart#L9)
