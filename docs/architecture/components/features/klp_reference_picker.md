# KlpReferencePicker：元件樹架構

## 範圍

- **核心元件**：`KlpReferencePicker`
- **所屬領域**：`features`
- **核心職責**：以查詢、載入狀態與受控結果清單呈現通用參照選擇器。
...
- 檔案路徑：[`lib/src/features/forms/picker/klp_reference_picker.dart`](../../../../lib/src/features/forms/picker/klp_reference_picker.dart#L12)
