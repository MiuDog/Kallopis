# KlpAffixedTextField：元件樹架構

## 範圍

- **核心元件**：`KlpAffixedTextField`
- **所屬領域**：`features`
- **核心職責**：在文字輸入旁提供不可編輯前綴與尾端語意動作。
...
- 檔案路徑：[`lib/src/features/forms/input/klp_affixed_text_field.dart`](../../../../lib/src/features/forms/input/klp_affixed_text_field.dart#L8)
