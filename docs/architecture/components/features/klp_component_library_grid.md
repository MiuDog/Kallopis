# KlpComponentLibraryGrid：元件樹架構

## 範圍

- **核心元件**：`KlpComponentLibraryGrid`
- **所屬領域**：`features`
- **核心職責**：元件定義的響應式預覽網格。
...
flowchart TD
  ...
  root["KlpComponentLibraryGrid"]:::root
  n1["KlpWrap"]:::reference
  root --> n1
  n2["KlpComponentDefinitionCard"]:::reference
  root --> n2
```

## 外部元件引用

- [`KlpComponentDefinitionCard`](./klp_component_definition_card.md) — `features`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/artifact/internal/klp_component_library_grid.dart`](../../../../lib/src/features/workspace/artifact/internal/klp_component_library_grid.dart#L4)
