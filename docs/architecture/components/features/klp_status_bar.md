...
- **核心元件**：`KlpStatusBar`
- **所屬領域**：`features`
- **核心職責**：狀態列元件。內部指示器使用 [KlpTextRole.status]。
...
- 檔案路徑：[`lib/src/features/workspace/shell/status/klp_status_bar.dart`](../../../../lib/src/features/workspace/shell/status/klp_status_bar.dart#L11)
