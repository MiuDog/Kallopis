...
flowchart TD
  ...
  n1["KlpSemanticRegion"]:::reference
  root --> n1
  n2["KlpConstrainedBox"]:::reference
  root --> n2
  n3["KlpBox"]:::reference
  root --> n3
  n4["KlpCenter"]:::reference
  root --> n4
  n5["KlpColumn"]:::reference
  root --> n5
  n6["KlpExcludeSemantics"]:::reference
  root --> n6
  n7["KlpRow"]:::reference
  root --> n7
  n8["KlpFlexible"]:::reference
  root --> n8
...
- [`KlpExcludeSemantics`](../foundation/klp_exclude_semantics.md) — `foundation — 圖示、色盤、度量`
- [`KlpFlexible`](../foundation/klp_flexible.md) — `foundation — 圖示、色盤、度量`
- [`KlpRow`](../foundation/klp_row.md) — `foundation — 圖示、色盤、度量`
- [`KlpSemanticRegion`](../foundation/klp_semantic_region.md) — `foundation — 圖示、色盤、度量`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/feedback/region_placeholder/klp_region_placeholder_widget.dart`](../../../../lib/src/features/feedback/region_placeholder/klp_region_placeholder_widget.dart#L3)
