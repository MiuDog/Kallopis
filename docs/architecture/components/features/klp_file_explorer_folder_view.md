...
flowchart TD
  ...
  root --> n6
  n7["KlpStateHighlight"]:::reference
  root --> n7
...
- 檔案路徑：[`lib/src/features/navigation/widgets/explorer/internal/klp_file_explorer_folder_view.dart`](../../../../lib/src/features/navigation/widgets/explorer/internal/klp_file_explorer_folder_view.dart#L4)
- 宣告型態：`StatefulWidget`
