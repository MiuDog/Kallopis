# KlpCanvasSelectionOverlay：元件樹架構

## 範圍

- **核心元件**：`KlpCanvasSelectionOverlay`
- **所屬領域**：`features`
- **核心職責**：選取範圍與可選 resize handles 的通用覆層。
...
flowchart TD
  ...
  root["KlpCanvasSelectionOverlay"]:::root
  n1["child / slot"]:::slot
  root --> n1
```
...
- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_canvas_selection_overlay.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_canvas_selection_overlay.dart#L4)
