# KlpFileExplorerSection：元件樹架構

## 範圍

- **核心元件**：`KlpFileExplorerSection`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpFileExplorerSection 元件
...
flowchart TD
  ...
  root["KlpFileExplorerSection"]:::root
...
- 檔案路徑：[`lib/src/features/navigation/widgets/explorer/models/klp_file_explorer_section.dart`](../../../../lib/src/features/navigation/widgets/explorer/models/klp_file_explorer_section.dart#L5)
