# KlpPhaseToggle：元件樹架構

## 範圍

- **核心元件**：`KlpPhaseToggle`
- **所屬領域**：`features`
- **核心職責**：階段／多態切換按鈕組。  邊框軌道、正方形分段，寬度隨選項數量延展。支援二態、三態與多選項目。
...
- 檔案路徑：[`lib/src/features/forms/toggle/internal/klp_phase_toggle_widget.dart`](../../../../lib/src/features/forms/toggle/internal/klp_phase_toggle_widget.dart#L6)
