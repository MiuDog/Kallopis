...
- **核心元件**：`KlpAppScreen`
- **所屬領域**：`features`
- **核心職責**：應用程式最外層，提供 Material 祖先與 app 背景。
...
- 檔案路徑：[`lib/src/features/workspace/shell/composition/app_screen/klp_app_screen.dart`](../../../../lib/src/features/workspace/shell/composition/app_screen/klp_app_screen.dart#L10)
