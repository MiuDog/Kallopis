...
- **核心元件**：`KlpModalFrame`
- **所屬領域**：`features`
- **核心職責**：透明 modal chrome 的基礎呈現原語；內容尺寸與產品語意由呼叫端提供。
...
- 檔案路徑：[`lib/src/features/overlays/primitives/klp_modal_frame.dart`](../../../../lib/src/features/overlays/primitives/klp_modal_frame.dart#L7)
