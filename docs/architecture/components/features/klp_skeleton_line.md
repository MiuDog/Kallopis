# KlpSkeletonLine：元件樹架構

## 範圍

- **核心元件**：`KlpSkeletonLine`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpSkeletonLine 元件
...
flowchart TD
  ...
  root["KlpSkeletonLine"]:::root
  n1["KlpExcludeSemantics"]:::reference
  root --> n1
  n2["KlpBox"]:::reference
  root --> n2
  n3["child / slot"]:::slot
...
- 檔案路徑：[`lib/src/features/feedback/empty_state/klp_skeleton_line.dart`](../../../../lib/src/features/feedback/empty_state/klp_skeleton_line.dart#L3)
