...
flowchart TD
  ...
  root --> n3
  n4["KlpPointerBlocker"]:::reference
  root --> n4
  n5["KlpCalendar"]:::reference
  root --> n5
...
- [`KlpCalendar`](./klp_calendar.md) — `features`
...
- 檔案路徑：[`lib/src/features/forms/selection/klp_date_field.dart`](../../../../lib/src/features/forms/selection/klp_date_field.dart#L10)
- 宣告型態：`StatefulWidget`
