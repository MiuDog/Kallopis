# KlpDocumentHeader：元件樹架構

## 範圍

- **核心元件**：`KlpDocumentHeader`
- **所屬領域**：`features`
- **核心職責**：結構化文件的標頭；修訂與狀態文字由產品提供。
...
- 檔案路徑：[`lib/src/features/workspace/artifact/internal/klp_document_header.dart`](../../../../lib/src/features/workspace/artifact/internal/klp_document_header.dart#L4)
