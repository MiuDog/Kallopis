...
- **核心元件**：`KlpCodeViewer`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpCodeViewer 元件
...
- 檔案路徑：[`lib/src/features/collections/code/internal/klp_code_viewer_widget.dart`](../../../../lib/src/features/collections/code/internal/klp_code_viewer_widget.dart#L3)
- 宣告型態：`StatefulWidget`
