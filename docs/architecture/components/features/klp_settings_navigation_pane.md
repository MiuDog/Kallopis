# KlpSettingsNavigationPane：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsNavigationPane`
- **所屬領域**：`features`
- **核心職責**：設定導覽 pane 的預設表面、內距與捲動行為。
...
flowchart TD
  ...
  root["KlpSettingsNavigationPane"]:::root
...
- 檔案路徑：[`lib/src/features/workspace/settings/layout/klp_settings_navigation_pane.dart`](../../../../lib/src/features/workspace/settings/layout/klp_settings_navigation_pane.dart#L4)
