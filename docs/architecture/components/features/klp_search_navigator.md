# KlpSearchNavigator：元件樹架構

## 範圍

- **核心元件**：`KlpSearchNavigator`
- **所屬領域**：`features`
- **核心職責**：呈現搜尋輸入、結果位置與前後導覽動作。
...
- 檔案路徑：[`lib/src/features/actions/editor/klp_search_navigator.dart`](../../../../lib/src/features/actions/editor/klp_search_navigator.dart#L4)
