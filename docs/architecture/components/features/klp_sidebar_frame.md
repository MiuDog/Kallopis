# KlpSidebarFrame：元件樹架構

## 範圍

- **核心元件**：`KlpSidebarFrame`
- **所屬領域**：`features`
- **核心職責**：側邊欄：由側邊欄自己決定內容與 footer 的內距，再交給無內距的 PanelFrame 提供背景、圓角與外側 dock margin。
...
- 檔案路徑：[`lib/src/features/workspace/shell/sidebar/klp_sidebar_frame.dart`](../../../../lib/src/features/workspace/shell/sidebar/klp_sidebar_frame.dart#L11)
