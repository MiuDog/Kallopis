# KlpEntityPicker：元件樹架構

## 範圍

- **核心元件**：`KlpEntityPicker`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpEntityPicker 元件
...
- 檔案路徑：[`lib/src/features/workspace/entity_picker/internal/klp_entity_picker_widget.dart`](../../../../lib/src/features/workspace/entity_picker/internal/klp_entity_picker_widget.dart#L3)
