...
- [`KlpFilePreview`](./klp_file_preview.md) — `features`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`
- [`KlpWrap`](../foundation/klp_wrap.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/forms/structured/internal/klp_file_field_widget.dart`](../../../../lib/src/features/forms/structured/internal/klp_file_field_widget.dart#L8)
