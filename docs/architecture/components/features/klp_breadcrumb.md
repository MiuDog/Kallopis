...
- **核心元件**：`KlpBreadcrumb`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpBreadcrumb 元件
...
- 檔案路徑：[`lib/src/features/navigation/widgets/breadcrumb/klp_breadcrumb.dart`](../../../../lib/src/features/navigation/widgets/breadcrumb/klp_breadcrumb.dart#L6)
