...
- **所屬領域**：`features`
- **核心職責**：狀態色彩角色色票組。只提供語意角色選擇，不提供直接色碼選擇。
...
- 檔案路徑：[`lib/src/features/forms/selection/klp_status_role_swatches.dart`](../../../../lib/src/features/forms/selection/klp_status_role_swatches.dart#L9)
