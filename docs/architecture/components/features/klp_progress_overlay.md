...
- [`KlpVeil`](../foundation/klp_veil.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/feedback/view_states/klp_progress_overlay.dart`](../../../../lib/src/features/feedback/view_states/klp_progress_overlay.dart#L3)
