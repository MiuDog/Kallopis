# KlpEditorToolbar：元件樹架構

## 範圍

- **核心元件**：`KlpEditorToolbar`
- **所屬領域**：`features`
- **核心職責**：以緊密節奏呈現可換行的編輯器動作。
...
- 檔案路徑：[`lib/src/features/actions/editor/klp_editor_toolbar.dart`](../../../../lib/src/features/actions/editor/klp_editor_toolbar.dart#L4)
