# KlpCanvasViewport：元件樹架構

## 範圍

- **核心元件**：`KlpCanvasViewport`
- **所屬領域**：`features`
- **核心職責**：編輯器畫布視窗；背景直接繼承 Stage surface，不建立另一塊畫布色。
...
- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_canvas_viewport.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_canvas_viewport.dart#L4)
