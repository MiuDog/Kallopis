# KlpSettingsScopeSwitcher：元件樹架構

## 範圍

- **核心元件**：`KlpSettingsScopeSwitcher`
- **所屬領域**：`features`
- **核心職責**：固定於 Settings 導覽頂部的等寬 scope 切換器。
...
flowchart TD
  ...
  root["KlpSettingsScopeSwitcher"]:::root
...
- 檔案路徑：[`lib/src/features/workspace/settings/navigation/klp_settings_scope_switcher.dart`](../../../../lib/src/features/workspace/settings/navigation/klp_settings_scope_switcher.dart#L4)
