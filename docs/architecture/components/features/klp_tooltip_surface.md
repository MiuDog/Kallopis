# KlpTooltipSurface：元件樹架構

## 範圍

- **核心元件**：`KlpTooltipSurface`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpTooltipSurface 元件
...
- 檔案路徑：[`lib/src/features/overlays/tooltip/klp_tooltip_surface.dart`](../../../../lib/src/features/overlays/tooltip/klp_tooltip_surface.dart#L3)
