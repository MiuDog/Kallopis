...
- **核心元件**：`KlpLayoutLens`
- **所屬領域**：`features`
- **核心職責**：顯示 layout、size、padding、gap 與 parent 關係，不推導文件狀態。
...
- 檔案路徑：[`lib/src/features/infinite_canvas/internal/klp_layout_lens.dart`](../../../../lib/src/features/infinite_canvas/internal/klp_layout_lens.dart#L4)
