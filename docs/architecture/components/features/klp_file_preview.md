...
- **核心元件**：`KlpFilePreview`
- **所屬領域**：`features`
- **核心職責**：檔案預覽卡片，呈現檔名、中繼資料、預覽內容與外部操作。
...
- 檔案路徑：[`lib/src/features/collections/advanced/internal/klp_file_preview.dart`](../../../../lib/src/features/collections/advanced/internal/klp_file_preview.dart#L4)
