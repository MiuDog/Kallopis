# KlpPopupInteractionScope：元件樹架構

## 範圍

- **核心元件**：`KlpPopupInteractionScope`
- **所屬領域**：`features`
- **核心職責**：供 App frame 注入視窗標題列保留範圍。
...
flowchart TD
  ...
  root["KlpPopupInteractionScope"]:::root
...
- 檔案路徑：[`lib/src/features/overlays/popup/klp_popup_interaction_scope.dart`](../../../../lib/src/features/overlays/popup/klp_popup_interaction_scope.dart#L4)
