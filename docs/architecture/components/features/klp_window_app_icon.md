# KlpWindowAppIcon：元件樹架構

## 範圍

- **核心元件**：`KlpWindowAppIcon`
- **所屬領域**：`features`
- **核心職責**：以視窗按鈕尺寸包裝消費端圖示，圖形本身維持 App icon 語意尺寸。
...
flowchart TD
  ...
  root["KlpWindowAppIcon"]:::root
  n1["KlpBox"]:::reference
  root --> n1
  n2["KlpCenter"]:::reference
  root --> n2
  n3["KlpFit"]:::reference
  root --> n3
  n4["child / slot"]:::slot
...
- [`KlpFit`](../foundation/klp_fit.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/workspace/shell/window/klp_window_app_icon.dart`](../../../../lib/src/features/workspace/shell/window/klp_window_app_icon.dart#L12)
