# KlpPanelHeader：元件樹架構

## 範圍

- **核心元件**：`KlpPanelHeader`
- **所屬領域**：`features`
- **核心職責**：面板標題列，集中排列標題、拖曳區、leading 與 actions。
...
- 檔案路徑：[`lib/src/features/workspace/shell/panel/klp_panel_header.dart`](../../../../lib/src/features/workspace/shell/panel/klp_panel_header.dart#L13)
