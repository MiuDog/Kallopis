# KlpStageTopBar：元件樹架構

## 範圍

- **核心元件**：`KlpStageTopBar`
- **所屬領域**：`features`
- **核心職責**：位於 Workbench window header 中央 Stage 區域的分頁與動作列。
...
flowchart TD
  ...
  root["KlpStageTopBar"]:::root
  n1["KlpStack"]:::reference
  root --> n1
  n2["KlpDirectionalPositioned"]:::reference
  root --> n2
  n3["KlpRow"]:::reference
  root --> n3
  n4["child / slot"]:::slot
...
- 檔案路徑：[`lib/src/features/workspace/shell/stage/klp_stage_top_bar.dart`](../../../../lib/src/features/workspace/shell/stage/klp_stage_top_bar.dart#L16)
