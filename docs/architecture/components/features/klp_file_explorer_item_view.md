# KlpFileExplorerItemView：元件樹架構

## 範圍

- **核心元件**：`KlpFileExplorerItemView`
- **所屬領域**：`features`
- **核心職責**：一般檔案項目視圖（含檔案圖示、文字標題、選取高亮與 Hover 回饋）。
...
flowchart TD
  ...
  root["KlpFileExplorerItemView"]:::root
  n1["KlpBox"]:::reference
  root --> n1
  n2["KlpRow"]:::reference
  root --> n2
  ...
  root --> n5
  n6["KlpStateHighlight"]:::reference
  root --> n6
...
- [`KlpStateHighlight`](../foundation/klp_state_highlight.md) — `foundation — 圖示、色盤、度量`
- [`KlpText`](../foundation/klp_text.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/features/navigation/widgets/explorer/internal/klp_file_explorer_item_view.dart`](../../../../lib/src/features/navigation/widgets/explorer/internal/klp_file_explorer_item_view.dart#L4)
- 宣告型態：`StatefulWidget`
