# KlpViewSwitcher：元件樹架構

## 範圍

- **核心元件**：`KlpViewSwitcher`
- **所屬領域**：`features`
- **核心職責**：以輕量分段表面呈現同層級檢視的受控切換器。
...
- 檔案路徑：[`lib/src/features/navigation/widgets/controls/klp_view_switcher.dart`](../../../../lib/src/features/navigation/widgets/controls/klp_view_switcher.dart#L18)
