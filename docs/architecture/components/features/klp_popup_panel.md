...
- **核心元件**：`KlpPopupPanel`
- **所屬領域**：`features`
- **核心職責**：Popup 的固定尺寸 surface。內容內距由 [child] 自己擁有。
...
- 檔案路徑：[`lib/src/features/overlays/popup/klp_popup_panel.dart`](../../../../lib/src/features/overlays/popup/klp_popup_panel.dart#L4)
