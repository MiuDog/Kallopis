# KlpApprovalStepsField：元件樹架構

## 範圍

- **核心元件**：`KlpApprovalStepsField`
- **所屬領域**：`features`
- **核心職責**：審批步驟排序欄位。支援步驟上下移動、刪除與新增。
...
flowchart TD
  ...
  root["KlpApprovalStepsField"]:::root
...
- 檔案路徑：[`lib/src/features/forms/structured/internal/klp_approval_steps_field_widget.dart`](../../../../lib/src/features/forms/structured/internal/klp_approval_steps_field_widget.dart#L4)
