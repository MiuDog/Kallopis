# KlpDocumentReferenceLink：元件樹架構

## 範圍

- **核心元件**：`KlpDocumentReferenceLink`
- **所屬領域**：`features`
- **核心職責**：指向另一個 canonical artifact 的可及性連結。
...
flowchart TD
  ...
  root["KlpDocumentReferenceLink"]:::root
  n1["KlpButton"]:::reference
  root --> n1
  n2["child / slot"]:::slot
  root --> n2
```
...
- 檔案路徑：[`lib/src/features/workspace/artifact/internal/klp_document_reference_link.dart`](../../../../lib/src/features/workspace/artifact/internal/klp_document_reference_link.dart#L4)
