...
- **核心元件**：`KlpListTile`
- **所屬領域**：`features`
- **核心職責**：以一致的 Kallopis 視覺呈現可選取的單列資料或動作。
...
- 檔案路徑：[`lib/src/features/collections/list_tile/internal/klp_list_tile_widget.dart`](../../../../lib/src/features/collections/list_tile/internal/klp_list_tile_widget.dart#L4)
