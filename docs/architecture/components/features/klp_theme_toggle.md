# KlpThemeToggle：元件樹架構

## 範圍

- **核心元件**：`KlpThemeToggle`
- **所屬領域**：`features`
- **核心職責**：Kallopis KlpThemeToggle 元件
...
- 檔案路徑：[`lib/src/features/workspace/shell/theme/klp_theme_toggle.dart`](../../../../lib/src/features/workspace/shell/theme/klp_theme_toggle.dart#L7)
