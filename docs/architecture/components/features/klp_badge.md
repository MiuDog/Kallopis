...
- **核心元件**：`KlpBadge`
- **所屬領域**：`features`
- **核心職責**：狀態標記。文字、內距與 pill 幾何皆由目前 Kallopis theme 解析。
...
- 檔案路徑：[`lib/src/features/collections/badge/internal/klp_badge_widget.dart`](../../../../lib/src/features/collections/badge/internal/klp_badge_widget.dart#L4)
