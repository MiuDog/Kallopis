...
- **所屬領域**：`form — 表單`
- **核心職責**：Kallopis KlpReferencePicker 元件
...
- 檔案路徑：[`lib/src/form/picker/klp_reference_picker.dart`](../../../../lib/src/form/picker/klp_reference_picker.dart#L20)
