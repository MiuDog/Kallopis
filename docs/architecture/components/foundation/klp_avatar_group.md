...
- **核心職責**：Kallopis KlpAvatarGroup 元件
...
- [`KlpAvatar`](./klp_avatar.md) — `foundation — 圖示、色盤、度量`

## 程式碼證據

- 檔案路徑：[`lib/src/foundation/klp_foundation_extras.dart`](../../../../lib/src/foundation/klp_foundation_extras.dart#L63)
