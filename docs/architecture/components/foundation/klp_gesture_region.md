# KlpGestureRegion：元件樹架構

## 範圍

- **核心元件**：`KlpGestureRegion`
- **所屬領域**：`foundation — 圖示、色盤、度量`
- **核心職責**：將產品事件接線隔離於 Kallopis 互動邊界內。
...
- 檔案路徑：[`lib/src/foundation/interaction/klp_gesture_region.dart`](../../../../lib/src/foundation/interaction/klp_gesture_region.dart#L4)
