# KlpDirectionalPositioned：元件樹架構

## 範圍

- **核心元件**：`KlpDirectionalPositioned`
- **所屬領域**：`foundation — 圖示、色盤、度量`
- **核心職責**：依文字方向解析 start／end 的定位排版原語。
...
flowchart TD
  ...
  root["KlpDirectionalPositioned"]:::root
  n1["child / slot"]:::slot
  root --> n1
```
...
- 檔案路徑：[`lib/src/foundation/layout/klp_directional_positioned.dart`](../../../../lib/src/foundation/layout/klp_directional_positioned.dart#L6)
