# KlpResizeHandle：元件樹架構

## 範圍

- **核心元件**：`KlpResizeHandle`
...
- 檔案路徑：[`lib/src/foundation/layout/klp_resize_handle.dart`](../../../../lib/src/foundation/layout/klp_resize_handle.dart#L6)
