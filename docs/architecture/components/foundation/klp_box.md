...
- **核心職責**：基礎尺寸與邊距容器排版原語。取代 Container 與 SizedBox。 支援風格介面、風格枚舉（KlpSpaceSize）與傳統尺寸邊距設定。
...
- 檔案路徑：[`lib/src/foundation/layout/klp_box.dart`](../../../../lib/src/foundation/layout/klp_box.dart#L10)
