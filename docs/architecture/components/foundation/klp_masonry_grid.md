# KlpMasonryGrid：元件樹架構

## 範圍

- **核心元件**：`KlpMasonryGrid`
- **所屬領域**：`foundation — 圖示、色盤、度量`
- **核心職責**：將高度不同的內容依序分配到多欄的瀑布流版面。
...
- 檔案路徑：[`lib/src/foundation/layout/klp_masonry_grid.dart`](../../../../lib/src/foundation/layout/klp_masonry_grid.dart#L6)
