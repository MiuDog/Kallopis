# KlpShortcutHint：元件樹架構

## 範圍

- **核心元件**：`KlpShortcutHint`
...
- 檔案路徑：[`lib/src/foundation/interaction/filter/internal/klp_shortcut_hint_widget.dart`](../../../../lib/src/foundation/interaction/filter/internal/klp_shortcut_hint_widget.dart#L4)
