# KlpPresenceIndicator：元件樹架構

## 範圍

- **核心元件**：`KlpPresenceIndicator`
...
flowchart TD
  ...
  root["KlpPresenceIndicator"]:::root
  n1["KlpRow"]:::reference
  root --> n1
```
...
- 檔案路徑：[`lib/src/foundation/interaction/filter/internal/klp_presence_indicator_widget.dart`](../../../../lib/src/foundation/interaction/filter/internal/klp_presence_indicator_widget.dart#L4)
