# KlpExcludeSemantics：元件樹架構

## 範圍

- **核心元件**：`KlpExcludeSemantics`
...
- 檔案路徑：[`lib/src/foundation/interaction/klp_exclude_semantics.dart`](../../../../lib/src/foundation/interaction/klp_exclude_semantics.dart#L4)
