...
- **核心職責**：絕對/相對定位排版原語。取代 Positioned。
...
- 檔案路徑：[`lib/src/foundation/layout/klp_positioned.dart`](../../../../lib/src/foundation/layout/klp_positioned.dart#L4)
