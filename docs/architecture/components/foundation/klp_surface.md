...
- **核心職責**：有底色的容器，是所有區塊的基底。`tone` 指定它在表面階層中的位置， 支援邊框、微漸層、外發光與霧化透明（毛玻璃）等多種原生 Box 視覺效果。
...
- [`KlpTokenOverride`](../styling/klp_token_override.md) — `styling`

## 程式碼證據

- 檔案路徑：[`lib/src/foundation/surface/klp_surface.dart`](../../../../lib/src/foundation/surface/klp_surface.dart#L12)
