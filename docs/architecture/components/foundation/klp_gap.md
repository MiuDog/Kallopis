...
- **核心職責**：間距排版原語。取代 SizedBox 進行彈性與固定距離佔位。 支援風格介面與風格枚舉（KlpSpaceSize）為第一優先真相。
...
- 檔案路徑：[`lib/src/foundation/layout/klp_gap.dart`](../../../../lib/src/foundation/layout/klp_gap.dart#L8)
