# KlpResizablePane：元件樹架構

## 範圍

- **核心元件**：`KlpResizablePane`
...
- 檔案路徑：[`lib/src/foundation/layout/klp_resizable_pane.dart`](../../../../lib/src/foundation/layout/klp_resizable_pane.dart#L4)
