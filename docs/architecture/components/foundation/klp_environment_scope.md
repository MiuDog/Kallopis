# KlpEnvironmentScope：元件樹架構

## 範圍

- **核心元件**：`KlpEnvironmentScope`
- **所屬領域**：`foundation — 圖示、色盤、度量`
- **核心職責**：注入執行平台；視窗尺寸、語系與互動狀態仍由各自的來源提供。
...
- 檔案路徑：[`lib/src/foundation/platform/klp_environment_scope.dart`](../../../../lib/src/foundation/platform/klp_environment_scope.dart#L6)
