# KlpPointerBlocker：元件樹架構

## 範圍

- **核心元件**：`KlpPointerBlocker`
- **所屬領域**：`foundation — 圖示、色盤、度量`
- **核心職責**：阻擋子樹指標事件、但保留其布局與繪製的基礎互動原語。
...
- 檔案路徑：[`lib/src/foundation/interaction/primitives/klp_pointer_blocker.dart`](../../../../lib/src/foundation/interaction/primitives/klp_pointer_blocker.dart#L4)
