# KlpSplitLayout：元件樹架構

## 範圍

- **核心元件**：`KlpSplitLayout`
- **所屬領域**：`foundation — 圖示、色盤、度量`
- **核心職責**：分割版面元件。支援左／中／右或左右分割，以及虛線分隔線。
...
- 檔案路徑：[`lib/src/foundation/layout/klp_split_layout.dart`](../../../../lib/src/foundation/layout/klp_split_layout.dart#L15)
