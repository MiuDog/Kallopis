...
- **核心職責**：行內程式碼片段。帶有圓角背景與等寬字體，適合在段落文字中呈現指令、變數或路徑。
...
- 檔案路徑：[`lib/src/foundation/klp_inline_code.dart`](../../../../lib/src/foundation/klp_inline_code.dart#L6)
