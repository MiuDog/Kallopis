# KlpAppWindowHeader：元件樹架構

## 範圍

- **核心元件**：`KlpAppWindowHeader`
- **所屬領域**：`shell — 應用外殼`
- **核心職責**：組合 App 視窗標題列的通用配方。
...
flowchart TD
  ...
  root["KlpAppWindowHeader"]:::root
  n1["SizedBox"]
  root --> n1
  n2["KlpPanelHeader"]:::reference
  n1 --> n2
  n3["leading (slot)"]:::slot
  n1 --> n3
  n4["child / slot"]:::slot
  n1 --> n4
```
...
- [`KlpPanelHeader`](./klp_panel_header.md) — `shell — 應用外殼`

## 程式碼證據

- 檔案路徑：[`lib/src/shell/composition/window_header/klp_app_window_header.dart`](../../../../lib/src/shell/composition/window_header/klp_app_window_header.dart#L8)
