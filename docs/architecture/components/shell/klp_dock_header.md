...
flowchart TD
  ...
  n3["Listener"]
  n1 --> n3
  n4["SingleChildScrollView"]
  n1 --> n4
  n5["KlpPanelHeader"]:::reference
  n4 --> n5
  n6["KlpIconButton"]:::reference
  n4 --> n6
  n7["Builder"]
  n4 --> n7
  n8["KlpContextMenu"]:::reference
  n4 --> n8
...
- [`KlpContextMenu`](../overlay/klp_context_menu.md) — `overlay — 浮層`
- [`KlpIconButton`](../controls/klp_icon_button.md) — `controls — 控制項`
- [`KlpPanelHeader`](./klp_panel_header.md) — `shell — 應用外殼`

## 程式碼證據

- 檔案路徑：[`lib/src/shell/docking/klp_dock_header.dart`](../../../../lib/src/shell/docking/klp_dock_header.dart#L19)
- 宣告型態：`StatefulWidget`
