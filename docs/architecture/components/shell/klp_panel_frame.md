...
- **核心元件**：`KlpPanelFrame`
- **所屬領域**：`shell — 應用外殼`
- **核心職責**：通用面板：header 與 content，選用 footer。高度預設沿用 theme 的外殼密度。 文字顏色依據背景顏色階梯（500 以下為深色文字，600 以上為淺色文字）渲染。
...
- 檔案路徑：[`lib/src/shell/klp_panel_frame.dart`](../../../../lib/src/shell/klp_panel_frame.dart#L7)
