...
- **核心元件**：`KlpStageTab`
- **所屬領域**：`shell — 應用外殼`
- **核心職責**：顯示目前 Stage 項目的單一檔案分頁。  此元件只擁有分頁的視覺語言；檔名與目前項目的資料來源由產品提供。
...
- 檔案路徑：[`lib/src/shell/stage/klp_stage_top_bar.dart`](../../../../lib/src/shell/stage/klp_stage_top_bar.dart#L48)
