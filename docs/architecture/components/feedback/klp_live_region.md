...
- **核心元件**：`KlpLiveRegion`
- **所屬領域**：`feedback — 狀態與回饋`
- **核心職責**：控制重複公告的可及性 live region；呼叫端提供已去重的訊息。
...
- 檔案路徑：[`lib/src/feedback/workflow/klp_finite_workflow.dart`](../../../../lib/src/feedback/workflow/klp_finite_workflow.dart#L147)
