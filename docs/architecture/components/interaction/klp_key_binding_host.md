# KlpKeyBindingHost：元件樹架構

## 範圍

- **核心元件**：`KlpKeyBindingHost`
- **所屬領域**：`interaction — 互動`
- **核心職責**：將 controller 的目前 scope 接到 Flutter Shortcuts／Actions。
...
- 檔案路徑：[`lib/src/interaction/keybinding/klp_key_binding_controller.dart`](../../../../lib/src/interaction/keybinding/klp_key_binding_controller.dart#L102)
