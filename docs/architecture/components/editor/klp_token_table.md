...
- [`KlpDataTable`](../data/klp_data_table.md) — `data — 資料呈現`
- [`KlpText`](../typography/klp_text.md) — `typography — 文字`

## 程式碼證據

- 檔案路徑：[`lib/src/editor/artifact_workspace/klp_artifact_workspace.dart`](../../../../lib/src/editor/artifact_workspace/klp_artifact_workspace.dart#L139)
