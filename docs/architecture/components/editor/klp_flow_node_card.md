# KlpFlowNodeCard：元件樹架構

## 範圍

- **核心元件**：`KlpFlowNodeCard`
- **所屬領域**：`editor — 編輯器周邊`
- **核心職責**：Flow 節點卡；節點種類與風險文字由呼叫端提供。
...
- 檔案路徑：[`lib/src/editor/canvas_workspace/klp_canvas_workspace.dart`](../../../../lib/src/editor/canvas_workspace/klp_canvas_workspace.dart#L132)
