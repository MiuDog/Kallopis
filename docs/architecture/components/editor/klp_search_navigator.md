...
- **所屬領域**：`editor — 編輯器周邊`
- **核心職責**：Kallopis KlpSearchNavigator 元件
...
- 檔案路徑：[`lib/src/editor/action_bars/klp_editor_action_bars.dart`](../../../../lib/src/editor/action_bars/klp_editor_action_bars.dart#L68)
