...
flowchart TD
  ...
  n5["SizedBox"]
  n3 --> n5
  n6["KlpTextField"]:::reference
  n5 --> n6
  n7["Row"]
  n5 --> n7
  n8["KlpButton"]:::reference
  n7 --> n8
  n9["child / slot"]:::slot
  n7 --> n9
```
...
- 檔案路徑：[`lib/src/editor/entity_picker/klp_entity_picker.dart`](../../../../lib/src/editor/entity_picker/klp_entity_picker.dart#L25)
