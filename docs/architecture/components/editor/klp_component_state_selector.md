...
- [`KlpTabs`](../navigation/klp_tabs.md) — `navigation — 導覽元件`

## 程式碼證據

- 檔案路徑：[`lib/src/editor/artifact_workspace/klp_artifact_workspace.dart`](../../../../lib/src/editor/artifact_workspace/klp_artifact_workspace.dart#L235)
