...
- [`KlpSlider`](./klp_slider.md) — `controls — 控制項`

## 程式碼證據

- 檔案路徑：[`lib/src/controls/color/klp_oklch_color_editor.dart`](../../../../lib/src/controls/color/klp_oklch_color_editor.dart#L11)
