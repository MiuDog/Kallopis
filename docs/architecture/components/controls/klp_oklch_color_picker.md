# KlpOklchColorPicker：元件樹架構

## 範圍

- **核心元件**：`KlpOklchColorPicker`
- **所屬領域**：`controls — 控制項`
- **核心職責**：以三個二維色彩平面與四軸控制編輯 [KlpOklchColor]。  元件不持有產品狀態；呼叫端以 [value] 與 [onChanged] 控制目前色彩。
...
flowchart TD
  ...
  n4["SizedBox"]
  n2 --> n4
  n5["KlpOklchColorEditor"]:::reference
  n4 --> n5
...
- [`KlpOklchColorEditor`](./klp_oklch_color_editor.md) — `controls — 控制項`
- [`KlpText`](../typography/klp_text.md) — `typography — 文字`

## 程式碼證據

- 檔案路徑：[`lib/src/controls/color/klp_oklch_color_picker.dart`](../../../../lib/src/controls/color/klp_oklch_color_picker.dart#L15)
