...
- [`KlpSlidingSelection`](./klp_sliding_selection.md) — `controls — 控制項`
- [`KlpText`](../typography/klp_text.md) — `typography — 文字`

## 程式碼證據

- 檔案路徑：[`lib/src/controls/toggle/klp_tri_state_toggle.dart`](../../../../lib/src/controls/toggle/klp_tri_state_toggle.dart#L10)
