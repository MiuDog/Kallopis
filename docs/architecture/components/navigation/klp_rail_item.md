...
flowchart TD
  ...
  n8["IgnorePointer"]
  n7 --> n8
  n9["KlpTooltipSurface"]:::reference
  n7 --> n9
  n10["Semantics"]
  n7 --> n10
  n11["child / slot"]:::slot
...
- [`KlpTooltipSurface`](../overlay/klp_tooltip_surface.md) — `overlay — 浮層`

## 程式碼證據

- 檔案路徑：[`lib/src/navigation/rail/klp_rail_item.dart`](../../../../lib/src/navigation/rail/klp_rail_item.dart#L7)
- 宣告型態：`StatefulWidget`
