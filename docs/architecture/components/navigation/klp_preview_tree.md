...
- **核心職責**：提案專用樹；語意名稱明確區分預覽節點與 canonical 導覽節點。
...
- 檔案路徑：[`lib/src/navigation/preview_tree/klp_preview_tree.dart`](../../../../lib/src/navigation/preview_tree/klp_preview_tree.dart#L25)
