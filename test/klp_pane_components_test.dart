...
void main() {
	testWidgets('responsive pane coordinator resolves the standard theme breakpoint', (tester) async {
	...
	testWidgets('pane collapse control exposes expansion semantics and dispatches toggle', (tester) async {
