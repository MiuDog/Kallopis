...
void main() {
  testWidgets('lightStyle and darkStyle remain complete consumer styles', (
    tester,
  ) async {
    ...
    expect(
      resolved.color.surface.toARGB32(),
      KlpThemeData.dark.surface.toARGB32(),
    );
    expect(
      resolved.dataVisualization.axis.toARGB32(),
      KlpDataVisualizationTheme.dark.axis.toARGB32(),
    );
    ...
    expect(
      resolved.color.surface.toARGB32(),
      KlpThemeData.light.surface.toARGB32(),
    );
    expect(
      resolved.dataVisualization.axis.toARGB32(),
      KlpDataVisualizationTheme.light.axis.toARGB32(),
    );
  });

  testWidgets('legacy style retains non-color layers and built-in palettes', (
    tester,
  ) async {
  ...
  testWidgets('system mode rebuilds when platform brightness changes', (
    tester,
  ) async {
  ...
  testWidgets('consumer localization delegate overrides built-in values', (
    tester,
  ) async {
