...
void main() {
	...
	test('all original localization defaults remain unchanged', () {
		...
		final fields = <String, (String, String)>{
			...
			'explorerActionsLabel': (value.explorerActionsLabel, 'Actions'),
			'explorerExpandLabel': (value.explorerExpandLabel, 'Expand'),
			'explorerCollapseLabel': (value.explorerCollapseLabel, 'Collapse'),
			'documentTabModifiedLabel': (value.documentTabModifiedLabel, 'Modified'),
			'documentTabPinLabel': (value.documentTabPinLabel, 'Pin'),
			'documentTabUnpinLabel': (value.documentTabUnpinLabel, 'Unpin'),
			'documentTabCloseLabel': (value.documentTabCloseLabel, 'Close'),
	...
	test('each override participates in equality and delegate reload', () {
		final changes = <String, stable.KlpLocalizations>{
			...
			'explorerActionsLabel': stable.KlpLocalizations(explorerActionsLabel: 'consumer override'),
			'explorerExpandLabel': stable.KlpLocalizations(explorerExpandLabel: 'consumer override'),
			'explorerCollapseLabel': stable.KlpLocalizations(explorerCollapseLabel: 'consumer override'),
			'documentTabModifiedLabel': stable.KlpLocalizations(documentTabModifiedLabel: 'consumer override'),
			'documentTabPinLabel': stable.KlpLocalizations(documentTabPinLabel: 'consumer override'),
			'documentTabUnpinLabel': stable.KlpLocalizations(documentTabUnpinLabel: 'consumer override'),
			'documentTabCloseLabel': stable.KlpLocalizations(documentTabCloseLabel: 'consumer override'),
