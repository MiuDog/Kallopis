...
final class KlpInstallationFixture {
  ...
  static KlpRegistry registry() => KlpRegistry([
    KlpDefinition<KlpTestItem>('item'),
    KlpDefinition<KlpTestItem>('other'),
  ]);
  ...
  KlpInstallationResource resource(String id) =>
      installation.resources[KlpPlacementId(localId: id)]!
          as KlpInstallationResource;
}
