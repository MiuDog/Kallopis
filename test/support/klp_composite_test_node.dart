...
final class KlpCompositeTestNode implements KlpCompositeNode, KlpRailItem, KlpScreenBody {
	...
	KlpCompositeTestNode(this.id, this.children, {this.label = 'Group', this.action});
