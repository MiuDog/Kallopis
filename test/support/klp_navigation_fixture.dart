...
KlpNavigationMachine klpNavigationTestMachine({required Iterable<KlpRoutePolicy> policies, required KlpLocation<Object?> initial, required void Function(KlpNavigationSnapshot) commit}) {
	final signal = KlpNavigationCancellation(Completer<void>().future, () => false);
	...
	if (started is! KlpNavigationStart || started.machine == null) throw StateError('Fixture requires successful synchronous navigation startup.');
