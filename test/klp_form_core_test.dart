...
void main() {
	testWidgets('form preserves semantic gaps between optional regions', (tester) async {
			...
			MaterialApp(
				...
				home: const Align(
					...
					child: SizedBox(
						width: 300,
						child: KlpForm(
							errorSummary: SizedBox(
								key: ValueKey('error-summary'),
								height: 8,
							),
							sections: [
	...
	testWidgets('form section preserves content and controlled collapse', (tester) async {
		var toggles = 0;
	...
	testWidgets('error summary preserves order and reports selected field', (tester) async {
		String? selected;
	...
	testWidgets('form actions preserve callbacks and submitting lock', (tester) async {
		var resetCount = 0;
		var cancelCount = 0;
		var submitCount = 0;
	...
	testWidgets('conditional field swaps content through its primitive boundary', (tester) async {
		await tester.pumpWidget(
			MaterialApp(
				theme: buildKlpTheme(Brightness.light),
