...
void main() {
	testWidgets('affixed input preserves geometry, editing, and action semantics', (tester) async {
		String? changed;
		var actionCount = 0;
	...
	testWidgets('quantity input preserves bounds and dispatches allowed changes', (tester) async {
		final values = <num>[];
	...
	testWidgets('date range preserves both editors and calendar callback', (tester) async {
		String? start;
		String? end;
		var calendarCount = 0;
