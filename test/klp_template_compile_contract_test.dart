...
import 'package:kallopis/src/foundation/templates/klp_text_semantics.dart';
...
''';
	...
	setUpAll(() async {
		fixture = await KlpExternalCompileFixture.create({
			'positive':
					"${prefix}final boundVocabulary = [text, linear, surface];\nfinal rail = KlpRail(id: KlpId.parse('rail'), top: [ExternalItem(KlpId.parse('item'), 'Label')]);\n",
	...
	test(
		'package internal item composes text linear and surface templates',
		() async {
