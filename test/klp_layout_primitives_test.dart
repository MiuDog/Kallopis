...
void main() {
  ...
  testWidgets('KlpGap resolves chrome toolbar semantic spacing', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    final gap = tester.widget<SizedBox>(
      find.descendant(of: find.byType(KlpGap), matching: find.byType(SizedBox)),
    );
  ...
  testWidgets('KlpBox resolves navigation rail control size', (tester) async {
    ...
    final box = tester.widget<SizedBox>(
      find
          .descendant(of: find.byType(KlpBox), matching: find.byType(SizedBox))
          .first,
    );
